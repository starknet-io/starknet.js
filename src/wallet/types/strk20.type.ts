import type {
  ...
  STRK20_SHADOW_ACCOUNT_INVOKE_ACTION as STRK20_SHADOW_ACCOUNT_INVOKE_ACTION_SPEC,
 ...
 * ```
 */
export type STRK20_SHADOW_ACCOUNT_INVOKE_ACTION = Omit<
  STRK20_SHADOW_ACCOUNT_INVOKE_ACTION_SPEC,
  'calls'
> & {
