...
import { Errors as PaymasterErrors } from './api/paymaster-rpc-spec';
...
export type RPC_ERROR_SET = {
  ...
  INVALID_ADDRESS: PaymasterErrors.INVALID_ADDRESS;
  TOKEN_NOT_SUPPORTED: PaymasterErrors.TOKEN_NOT_SUPPORTED;
  INVALID_SIGNATURE: PaymasterErrors.INVALID_SIGNATURE;
  MAX_AMOUNT_TOO_LOW: PaymasterErrors.MAX_AMOUNT_TOO_LOW;
  CLASS_HASH_NOT_SUPPORTED: PaymasterErrors.CLASS_HASH_NOT_SUPPORTED;
  PAYMASTER_TRANSACTION_EXECUTION_ERROR: PaymasterErrors.TRANSACTION_EXECUTION_ERROR;
  INVALID_TIME_BOUNDS: PaymasterErrors.INVALID_TIME_BOUNDS;
  INVALID_DEPLOYMENT_DATA: PaymasterErrors.INVALID_DEPLOYMENT_DATA;
  INVALID_CLASS_HASH: PaymasterErrors.INVALID_CLASS_HASH;
  INVALID_ID: PaymasterErrors.INVALID_ID;
  UNKNOWN_ERROR: PaymasterErrors.UNKNOWN_ERROR;
};
