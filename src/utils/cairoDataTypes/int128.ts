 ...
 * new CairoInt128(-5).toBigInt(); //     -5n
 * new CairoInt128('-5').toBigInt(); //   -5n
 * new CairoInt128('-0x5').toBigInt(); // -5n     a sign, not the text "-0x5"
 * ```
 */
export class CairoInt128 {
   ...
   * leading minus sign — and as UTF-8 text otherwise. Text therefore only fits here up to 16 ASCII
   * characters : one more already makes a number past 170141183460469231731687303715884105727.
   ...
   * const result2 = new CairoInt128('-5').toApiRequest();
   ...
   * const result3 = CairoInt128.__processData('-0x5');
   ...
   * an array, a number with a decimal part, `'0x'`, and a value outside [-170141183460469231731687303715884105728, 170141183460469231731687303715884105727]. A text string reaches
