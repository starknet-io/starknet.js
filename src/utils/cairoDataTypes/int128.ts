...
import { RANGE_I128 } from '../../global/constants';
...
export class CairoInt128 {
  ...
  toHexString() {
    ...
    if (value < 0) {
      // Convert negative value to two's complement 128-bit representation
      value = 340282366920938463463374607431768211456n + value; // 2^128
    }
