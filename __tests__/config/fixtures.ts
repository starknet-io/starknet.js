...
export const compiledArgentAccount = readContractSierra('cairo/account/accountArgent031');
export const compiledArgentAccountCasm = readContractSierraCasm('cairo/account/accountArgent031');
