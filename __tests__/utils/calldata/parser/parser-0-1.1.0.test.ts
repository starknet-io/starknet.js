import { hdParsingStrategy } from '../../../../src';
...
describe('AbiParser1', () => {
  test('should create an instance', () => {
    const abiParser = new AbiParser1([getFunctionAbi('struct')], hdParsingStrategy);
  ...
  describe('methodInputsLength', () => {
    ...
    test('should return 0 if inputs are empty', () => {
      const abiParser = new AbiParser1([getFunctionAbi('felt')], hdParsingStrategy);
  ...
  describe('getMethod', () => {
    test('should return method definition from ABI', () => {
      const abiParser = new AbiParser1(
        [getFunctionAbi('struct'), getInterfaceAbi()],
        hdParsingStrategy
      );
