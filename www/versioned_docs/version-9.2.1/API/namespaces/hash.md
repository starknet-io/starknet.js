...
[src/utils/hash/classHash/util.ts:10](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/util.ts#L10)
...
| :------ | :------------------------------------------- | :------------ |
| `value` | [`BigNumberish`](../modules.md#bignumberish) | value to hash |
...
[src/utils/hash/selector.ts:21](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/selector.ts#L21)
...
[src/utils/hash/selector.ts:50](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/selector.ts#L50)
...
[src/utils/hash/selector.ts:68](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/selector.ts#L68)
...
| Name    | Type                                         | Description                                                  |
| :------ | :------------------------------------------- | :----------------------------------------------------------- |
| `value` | [`BigNumberish`](../modules.md#bignumberish) | ascii-string \| hex-string \| dec-string \| number \| BigInt |
...
[src/utils/hash/selector.ts:93](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/selector.ts#L93)
...
| Name     | Type                                           | Description                 |
| :------- | :--------------------------------------------- | :-------------------------- |
| `params` | [`BigNumberish`](../modules.md#bignumberish)[] | an array of uint256 numbers |
...
[src/utils/hash/selector.ts:110](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/selector.ts#L110)
...
| Name            | Type                                           | Description                                                                  |
| :-------------- | :--------------------------------------------- | :--------------------------------------------------------------------------- |
| `l1FromAddress` | [`BigNumberish`](../modules.md#bignumberish)   | L1 account address that paid the message.                                    |
| `l2ToAddress`   | [`BigNumberish`](../modules.md#bignumberish)   | L2 contract address to execute.                                              |
| `l2Selector`    | [`BigNumberish`](../modules.md#bignumberish)   | can be a function name ("bridge_withdraw") or a number (BigNumberish).       |
| `l2Calldata`    | [`BigNumberish`](../modules.md#bignumberish)[] | an array of BigNumberish of the raw parameters passed to the above function. |
| `l1Nonce`       | [`BigNumberish`](../modules.md#bignumberish)   | The nonce of the L1 account.                                                 |
...
[src/utils/hash/selector.ts:145](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/selector.ts#L145)
...
| Name            | Type                                           | Description                                                           |
| :-------------- | :--------------------------------------------- | :-------------------------------------------------------------------- |
| `fromL2Address` | [`BigNumberish`](../modules.md#bignumberish)   | L2 contract address that send the message.                            |
| `toL1Address`   | [`BigNumberish`](../modules.md#bignumberish)   | Recipient L1 account address.                                         |
| `payload`       | [`BigNumberish`](../modules.md#bignumberish)[] | an array of BigNumberish of the raw parameters passed to the message. |
...
[src/utils/hash/selector.ts:183](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/selector.ts#L183)
...
[src/utils/hash/transactionHash/index.ts:42](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/transactionHash/index.ts#L42)
...
[src/utils/hash/transactionHash/index.ts:86](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/transactionHash/index.ts#L86)
...
| Name   | Type                            |
| :----- | :------------------------------ |
| `args` | `CalcV3DeployAccountTxHashArgs` |
...
[src/utils/hash/transactionHash/index.ts:134](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/transactionHash/index.ts#L134)
...
| `l2ToAddress`   | [`BigNumberish`](../modules.md#bignumberish)       | L2 contract address to execute.                                              |
| `l2Selector`    | [`BigNumberish`](../modules.md#bignumberish)       | can be a function name ("bridge_withdraw") or a number (BigNumberish).       |
| `l2Calldata`    | [`RawCalldata`](../modules.md#rawcalldata)         | an array of BigNumberish of the raw parameters passed to the above function. |
...
[src/utils/hash/transactionHash/v2.ts:158](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/transactionHash/v2.ts#L158)
...
| Name       | Type                                                             | Description              |
| :--------- | :--------------------------------------------------------------- | :----------------------- |
| `contract` | `string` \| [`CompiledContract`](../modules.md#compiledcontract) | Cairo 1 contract content |
...
[src/utils/hash/classHash/index.ts:33](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/index.ts#L33)

---

### computeCompiledClassHash

▸ **computeCompiledClassHash**(`casm`, `starknetVersion?`): `string`

#### Parameters

| Name              | Type                                           | Default value                                      | Description                                      |
| :---------------- | :--------------------------------------------- | :------------------------------------------------- | :----------------------------------------------- |
| `casm`            | [`CairoAssembly`](../modules.md#cairoassembly) | `undefined`                                        | -                                                |
| `starknetVersion` | `string`                                       | `SN_VERSION_IMPLEMENTING_BLAKE_FOR_COMPILED_CLASS` | Used to determine which hashing algorithm to use |
...
[src/utils/hash/classHash/index.ts:43](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/index.ts#L43)
...
| Name | Type                                         |
| :--- | :------------------------------------------- |
| `a`  | [`BigNumberish`](../modules.md#bignumberish) |
| `b`  | [`BigNumberish`](../modules.md#bignumberish) |
...
[src/utils/hash/classHash/pedersen.ts:17](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/pedersen.ts#L17)
...
| Name   | Type                                           | Description                               |
| :----- | :--------------------------------------------- | :---------------------------------------- |
| `data` | [`BigNumberish`](../modules.md#bignumberish)[] | Array of data to compute Pedersen hash on |
...
[src/utils/hash/classHash/pedersen.ts:33](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/pedersen.ts#L33)
...
| Name                  | Type                                         | Description                                    |
| :-------------------- | :------------------------------------------- | :--------------------------------------------- |
| `salt`                | [`BigNumberish`](../modules.md#bignumberish) | Salt to be used for hashing                    |
| `classHash`           | [`BigNumberish`](../modules.md#bignumberish) | Class hash of contract to generate address for |
| `constructorCalldata` | [`RawArgs`](../modules.md#rawargs)           | Call data for contract constructor             |
| `deployerAddress`     | [`BigNumberish`](../modules.md#bignumberish) | Address of contract deployer                   |
...
[src/utils/hash/classHash/pedersen.ts:55](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/pedersen.ts#L55)
...
[src/utils/hash/classHash/pedersen.ts:86](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/pedersen.ts#L86)
...
| Name       | Type                                                                         | Description                      |
| :--------- | :--------------------------------------------------------------------------- | :------------------------------- |
| `contract` | `string` \| [`LegacyCompiledContract`](../modules.md#legacycompiledcontract) | legacy compiled contract content |
...
[src/utils/hash/classHash/pedersen.ts:104](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/pedersen.ts#L104)
...
[src/utils/hash/classHash/pedersen.ts:39](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/pedersen.ts#L39)
...
[src/utils/hash/classHash/poseidon.ts:21](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/poseidon.ts#L21)
...
[src/utils/hash/classHash/poseidon.ts:25](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/poseidon.ts#L25)
...
| Name   | Type                                           | Description                        |
| :----- | :--------------------------------------------- | :--------------------------------- |
| `casm` | [`CairoAssembly`](../modules.md#cairoassembly) | compiled Sierra CASM file content. |
...
[src/utils/hash/classHash/poseidon.ts:53](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/poseidon.ts#L53)
...
| Name   | Type                                           | Description                       |
| :----- | :--------------------------------------------- | :-------------------------------- |
| `casm` | [`CairoAssembly`](../modules.md#cairoassembly) | Cairo 1 compiled contract content |
...
[src/utils/hash/classHash/poseidon.ts:75](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/poseidon.ts#L75)
...
| Name     | Type                                             | Description                     |
| :------- | :----------------------------------------------- | :------------------------------ |
| `sierra` | [`CompiledSierra`](../modules.md#compiledsierra) | Cairo 1 Sierra contract content |
...
[src/utils/hash/classHash/poseidon.ts:127](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/poseidon.ts#L127)
...
[src/utils/hash/classHash/blake.ts:22](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/blake.ts#L22)
...
[src/utils/hash/classHash/blake.ts:123](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/blake.ts#L123)
...
[src/utils/hash/classHash/blake.ts:155](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/blake.ts#L155)
...
[src/utils/hash/classHash/util.ts:22](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/util.ts#L22)
...
[src/utils/hash/classHash/util.ts:44](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/util.ts#L44)
...
[src/utils/hash/classHash/util.ts:60](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/util.ts#L60)
...
| Name                   | Type                                                                   |
| :--------------------- | :--------------------------------------------------------------------- |
| `data`                 | [`ContractEntryPointFields`](../modules.md#contractentrypointfields)[] |
...
[src/utils/hash/classHash/util.ts:68](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/hash/classHash/util.ts#L68)
