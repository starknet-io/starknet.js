...
▸ **toOutsideCallV2**(`call`): [`OutsideCallV2`](RPC.RPCSPEC010.WALLET_API.md#outsidecallv2)

#### Parameters

| Name   | Type                                                                                                                           |
| :----- | :----------------------------------------------------------------------------------------------------------------------------- |
| `call` | [`OutsideCallV1`](RPC.RPCSPEC010.WALLET_API.md#outsidecallv1) \| [`OutsideCallV2`](RPC.RPCSPEC010.WALLET_API.md#outsidecallv2) |

#### Returns

[`OutsideCallV2`](RPC.RPCSPEC010.WALLET_API.md#outsidecallv2)

#### Defined in

[src/utils/outsideExecution.ts:17](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/outsideExecution.ts#L17)
...
| :----- | :--------------------------- | :---------------------- |
| `call` | [`Call`](../modules.md#call) | transaction to proceed. |
...
[src/utils/outsideExecution.ts:47](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/outsideExecution.ts#L47)

---

### getTypedData

▸ **getTypedData**(`chainId`, `options`, `nonce`, `myCalls`, `version`): [`TypedData`](../interfaces/RPC.RPCSPEC010.WALLET_API.TypedData.md)
...
| `options` | [`OutsideExecutionOptions`](../interfaces/OutsideExecutionOptions.md) | Parameters related to an Outside Execution.                             |
| `nonce`   | [`BigNumberish`](../modules.md#bignumberish)                          | Outside execution nonce (not to confuse with normal transaction nonce). |
| `myCalls` | [`Call`](../modules.md#call)[]                                        | transaction(s) to proceed.                                              |
...
[src/utils/outsideExecution.ts:117](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/outsideExecution.ts#L117)

---

### buildExecuteFromOutsideCallData

▸ **buildExecuteFromOutsideCallData**(`outsideTransaction`): [`Calldata`](../modules.md#calldata)
...
| Name                 | Type                                                        | Description                                                   |
| :------------------- | :---------------------------------------------------------- | :------------------------------------------------------------ |
| `outsideTransaction` | [`OutsideTransaction`](../interfaces/OutsideTransaction.md) | an object that contains all the data for a Outside Execution. |
...
[src/utils/outsideExecution.ts:175](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/outsideExecution.ts#L175)

---

### buildExecuteFromOutsideCall

▸ **buildExecuteFromOutsideCall**(`outsideTransaction`): [`Call`](../modules.md#call)[]
...
| Name                 | Type                                                                                                   | Description                                                    |
| :------------------- | :----------------------------------------------------------------------------------------------------- | :------------------------------------------------------------- |
| `outsideTransaction` | [`AllowArray`](../modules.md#allowarray)<[`OutsideTransaction`](../interfaces/OutsideTransaction.md)\> | an object that contains all the data for an Outside Execution. |
...
[src/utils/outsideExecution.ts:209](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/outsideExecution.ts#L209)
