...
[src/utils/typedData.ts:102](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L102)
...
[src/utils/typedData.ts:125](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L125)
...
| Name   | Type                                                        | Description                 |
| :----- | :---------------------------------------------------------- | :-------------------------- |
| `type` | [`StarknetType`](RPC.RPCSPEC010.WALLET_API.md#starknettype) | The StarkNet type to check. |
...
[src/utils/typedData.ts:147](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L147)
...
| :-------------- | :------------------------------------------------------------------------------- | :---------------- | :--------------------------------------------- |
| `types`         | `Record<string`, [`StarknetType`](RPC.RPCSPEC010.WALLET_API.md#starknettype)[]\> | `undefined`       | The types object containing all defined types. |
...
| `revision?`     | [`TypedDataRevision`](RPC.RPCSPEC010.WALLET_API.md#typeddatarevision)            | `Revision.LEGACY` | The revision of the TypedData.                 |
...
[src/utils/typedData.ts:163](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L163)
...
[src/utils/typedData.ts:245](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L245)
...
[src/utils/typedData.ts:304](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L304)
...
[src/utils/typedData.ts:335](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L335)
...
| Name | Type                                                                        |
| :--- | :-------------------------------------------------------------------------- |
| `T`  | extends [`TypedData`](../interfaces/RPC.RPCSPEC010.WALLET_API.TypedData.md) |
...
[src/utils/typedData.ts:473](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L473)
...
[src/utils/typedData.ts:528](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L528)
...
| Name             | Type                                                                | Description                              |
| :--------------- | :------------------------------------------------------------------ | :--------------------------------------- |
| `typedData`      | [`TypedData`](../interfaces/RPC.RPCSPEC010.WALLET_API.TypedData.md) | The TypedData object.                    |
| `accountAddress` | [`BigNumberish`](../modules.md#bignumberish)                        | The account address to sign the message. |
...
[src/utils/typedData.ts:595](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L595)
...
| Name              | Type                                                                | Description                                                                                                 |
| :---------------- | :------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------- |
| `message`         | [`TypedData`](../interfaces/RPC.RPCSPEC010.WALLET_API.TypedData.md) | a TypedMessage message, or the hash of an EIP712 message (SNIP-12).                                         |
| `signature`       | [`Signature`](../modules.md#signature)                              | a WeierstrassSignatureType signature, or an array of 2 strings.                                             |
| `fullPublicKey`   | [`BigNumberish`](../modules.md#bignumberish)                        | a number coded on 520 bits (from ec.getFullPublicKey()).                                                    |
| `accountAddress?` | [`BigNumberish`](../modules.md#bignumberish)                        | address of the account that has signed the message. Not needed with a message hash is provided in `message` |
...
[src/utils/typedData.ts:632](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L632)
...
| Name            | Type                                         |
| :-------------- | :------------------------------------------- |
| `message`       | [`BigNumberish`](../modules.md#bignumberish) |
| `signature`     | [`Signature`](../modules.md#signature)       |
| `fullPublicKey` | [`BigNumberish`](../modules.md#bignumberish) |
...
[src/utils/typedData.ts:638](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/utils/typedData.ts#L638)
