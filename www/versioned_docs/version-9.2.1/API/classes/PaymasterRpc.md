...
| Name       | Type                                                                                                                                          |
| :--------- | :-------------------------------------------------------------------------------------------------------------------------------------------- |
| `options?` | [`PaymasterOptions`](../interfaces/PaymasterOptions.md) \| [`PaymasterInterface`](PaymasterInterface.md) \| [`PaymasterRpc`](PaymasterRpc.md) |
...
[src/paymaster/rpc.ts:84](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L84)
...
[src/paymaster/rpc.ts:76](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L76)
...
[src/paymaster/rpc.ts:78](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L78)
...
[src/paymaster/rpc.ts:80](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L80)
...
[src/paymaster/rpc.ts:82](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L82)
...
[src/paymaster/rpc.ts:114](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L114)
...
[src/paymaster/rpc.ts:128](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L128)

---

### fetchEndpoint

▸ **fetchEndpoint**\<`T`\>(`method`, `params?`): `Promise`\<[`Methods`](../namespaces/RPC.RPCSPEC010.PAYMASTER_API.md#methods)[`T`][``"result"``]\>
...
| :-------- | :------------------------------------------------------------------------------------ |
| `method`  | `T`                                                                                   |
| `params?` | [`Methods`](../namespaces/RPC.RPCSPEC010.PAYMASTER_API.md#methods)[`T`][``"params"``] |

#### Returns

`Promise`\<[`Methods`](../namespaces/RPC.RPCSPEC010.PAYMASTER_API.md#methods)[`T`][``"result"``]\>

#### Defined in

[src/paymaster/rpc.ts:140](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L140)
...
[src/paymaster/rpc.ts:156](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L156)
...
[src/paymaster/rpc.ts:160](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L160)

---

### executeTransaction

▸ **executeTransaction**(`transaction`, `parameters`): `Promise`\<[`ExecuteResponse`](../namespaces/RPC.RPCSPEC010.PAYMASTER_API.md#executeresponse)\>
...
`Promise`\<[`ExecuteResponse`](../namespaces/RPC.RPCSPEC010.PAYMASTER_API.md#executeresponse)\>
...
[src/paymaster/rpc.ts:238](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L238)
...
[src/paymaster/rpc.ts:282](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/paymaster/rpc.ts#L282)
