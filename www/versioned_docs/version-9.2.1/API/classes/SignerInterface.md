...
[src/signer/interface.ts:22](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/signer/interface.ts#L22)
...
| :--------------- | :------------------------------------------------------------------ | :---------------------------------- |
| `typedData`      | [`TypedData`](../interfaces/RPC.RPCSPEC010.WALLET_API.TypedData.md) | JSON object to be signed            |
...
[src/signer/interface.ts:56](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/signer/interface.ts#L56)
...
| `transactionsDetail` | [`InvocationsSignerDetails`](../modules.md#invocationssignerdetails) | Transaction details including V3 fields             |
...
[src/signer/interface.ts:95](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/signer/interface.ts#L95)

---

### signDeployAccountTransaction

▸ **signDeployAccountTransaction**(`transaction`): `Promise`\<[`Signature`](../modules.md#signature)\>
...
| Name          | Type                                                                         | Description                                       |
| :------------ | :--------------------------------------------------------------------------- | :------------------------------------------------ |
| `transaction` | [`V3DeployAccountSignerDetails`](../modules.md#v3deployaccountsignerdetails) | Transaction details to deploy an account contract |
...
[src/signer/interface.ts:133](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/signer/interface.ts#L133)

---

### signDeclareTransaction

▸ **signDeclareTransaction**(`transaction`): `Promise`\<[`Signature`](../modules.md#signature)\>
...
| Name          | Type                                                         | Description                                     |
| :------------ | :----------------------------------------------------------- | :---------------------------------------------- |
| `transaction` | [`DeclareSignerDetails`](../modules.md#declaresignerdetails) | Transaction details to declare a contract class |
...
[src/signer/interface.ts:169](https://github.com/starknet-io/starknet.js/blob/v9.2.1/src/signer/interface.ts#L169)
