# Abstract Class: SignerInterface

Defined in: [src/signer/interface.ts:10](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/interface.ts#L10)
...
Defined in: [src/signer/interface.ts:22](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/interface.ts#L22)
...
> `abstract` **signMessage**(`typedData`, `accountAddress`): `Promise`\<[`Signature`](../type-aliases/Signature.md)\>

Defined in: [src/signer/interface.ts:56](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/interface.ts#L56)
...
> `abstract` **signTransaction**(`transactions`, `transactionsDetail`): `Promise`\<[`Signature`](../type-aliases/Signature.md)\>

Defined in: [src/signer/interface.ts:95](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/interface.ts#L95)
...
Transaction details including V3 fields
...
> `abstract` **signDeployAccountTransaction**(`transaction`): `Promise`\<[`Signature`](../type-aliases/Signature.md)\>

Defined in: [src/signer/interface.ts:133](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/interface.ts#L133)
...
Transaction details to deploy an account contract
...
> `abstract` **signDeclareTransaction**(`transaction`): `Promise`\<[`Signature`](../type-aliases/Signature.md)\>

Defined in: [src/signer/interface.ts:169](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/interface.ts#L169)
...
Transaction details to declare a contract class
