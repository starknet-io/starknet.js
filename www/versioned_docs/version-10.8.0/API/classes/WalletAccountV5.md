...
Defined in: [src/wallet/accountV5.ts:49](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/wallet/accountV5.ts#L49)
...
- [`WalletAccountV6`](WalletAccountV6.md)
...
Defined in: [src/wallet/accountV5.ts:64](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/wallet/accountV5.ts#L64)
...
> `static` **connect**(`provider`, `walletProvider`, `cairoVersion?`, `paymaster?`, `silentMode?`): `Promise`\<`WalletAccountV5`\>

Defined in: [src/wallet/accountV5.ts:182](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/wallet/accountV5.ts#L182)
...
> `static` **connectSilent**(`provider`, `walletProvider`, `cairoVersion?`, `paymaster?`): `Promise`\<`WalletAccountV5`\>

Defined in: [src/wallet/accountV5.ts:204](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/wallet/accountV5.ts#L204)
...
Unsubscribe from all wallet events, including the callbacks registered through [onChange](#onchange).
...
Defined in: [src/wallet/accountV5.ts:117](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/wallet/accountV5.ts#L117)
