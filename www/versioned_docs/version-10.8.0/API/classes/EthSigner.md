...
Defined in: [src/signer/ethSigner.ts:36](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L36)
...
> **new EthSigner**(`pk?`): `EthSigner`

Defined in: [src/signer/ethSigner.ts:39](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L39)
...
Defined in: [src/signer/ethSigner.ts:37](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L37)
...
Defined in: [src/signer/ethSigner.ts:50](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L50)
...
> **signMessage**(`typedData`, `accountAddress`): `Promise`\<[`Signature`](../type-aliases/Signature.md)\>

Defined in: [src/signer/ethSigner.ts:56](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L56)
...
> **signTransaction**(`transactions`, `details`): `Promise`\<[`Signature`](../type-aliases/Signature.md)\>

Defined in: [src/signer/ethSigner.ts:65](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L65)
...
Defined in: [src/signer/ethSigner.ts:92](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L92)
...
Defined in: [src/signer/ethSigner.ts:119](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L119)
...
> `protected` **formatEthSignature**(`ethSignature`): [`ArraySignatureType`](../type-aliases/ArraySignatureType.md)

Defined in: [src/signer/ethSigner.ts:149](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/signer/ethSigner.ts#L149)
...
[`RecoveredSignatureType`](../Starknet.js-API/namespaces/ec/namespaces/weierstrass/type-aliases/RecoveredSignatureType.md)

secp256k1 signature from Noble curves library
