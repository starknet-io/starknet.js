...
> **getExecuteCalldata**(`calls`, `cairoVersion?`): [`Calldata`](../../../../type-aliases/Calldata.md)

Defined in: [src/utils/transaction/transaction.ts:155](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/utils/transaction/transaction.ts#L155)
...
[`CairoVersion`](../../../../type-aliases/CairoVersion.md) = `'0'`
