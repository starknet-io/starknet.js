# Function: fromCallsToExecuteCalldata_cairo1()

> **fromCallsToExecuteCalldata_cairo1**(`calls`): [`Calldata`](../../../../type-aliases/Calldata.md)

Defined in: [src/utils/transaction/transaction.ts:114](https://github.com/starknet-io/starknet.js/blob/v10.8.0/src/utils/transaction/transaction.ts#L114)
