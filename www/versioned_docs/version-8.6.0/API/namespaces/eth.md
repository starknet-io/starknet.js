...
[src/utils/eth.ts:18](https://github.com/starknet-io/starknet.js/blob/v8.6.0/src/utils/eth.ts#L18)
...
| :-------- | :------------------------------------------- | :------------------------------ |
| `address` | [`BigNumberish`](../modules.md#bignumberish) | Address of an Ethereum account. |
...
[src/utils/eth.ts:32](https://github.com/starknet-io/starknet.js/blob/v8.6.0/src/utils/eth.ts#L32)
