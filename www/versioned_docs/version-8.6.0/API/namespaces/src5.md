...
| `contractAddress` | [`BigNumberish`](../modules.md#bignumberish) | the address of the contract to check.   |
| `interfaceId`     | [`BigNumberish`](../modules.md#bignumberish) | the hash of the functionality to check. |
...
[src/utils/src5.ts:19](https://github.com/starknet-io/starknet.js/blob/v8.6.0/src/utils/src5.ts#L19)
