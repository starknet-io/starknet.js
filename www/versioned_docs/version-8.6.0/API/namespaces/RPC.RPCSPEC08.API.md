---
id: 'RPC.RPCSPEC08.API'
title: 'Namespace: API'
sidebar_label: 'API'
custom_edit_url: null
---

[RPC](RPC.md).[RPCSPEC08](RPC.RPCSPEC08.md).API

## Namespaces

- [CONTRACT](RPC.RPCSPEC08.API.CONTRACT.md)

## Interfaces

- [FAILED_TO_RECEIVE_TXN](../interfaces/RPC.RPCSPEC08.API.FAILED_TO_RECEIVE_TXN.md)
- [NO_TRACE_AVAILABLE](../interfaces/RPC.RPCSPEC08.API.NO_TRACE_AVAILABLE.md)
- [CONTRACT_NOT_FOUND](../interfaces/RPC.RPCSPEC08.API.CONTRACT_NOT_FOUND.md)
- [ENTRYPOINT_NOT_FOUND](../interfaces/RPC.RPCSPEC08.API.ENTRYPOINT_NOT_FOUND.md)
- [BLOCK_NOT_FOUND](../interfaces/RPC.RPCSPEC08.API.BLOCK_NOT_FOUND.md)
- [INVALID_TXN_INDEX](../interfaces/RPC.RPCSPEC08.API.INVALID_TXN_INDEX.md)
- [CLASS_HASH_NOT_FOUND](../interfaces/RPC.RPCSPEC08.API.CLASS_HASH_NOT_FOUND.md)
- [TXN_HASH_NOT_FOUND](../interfaces/RPC.RPCSPEC08.API.TXN_HASH_NOT_FOUND.md)
- [PAGE_SIZE_TOO_BIG](../interfaces/RPC.RPCSPEC08.API.PAGE_SIZE_TOO_BIG.md)
- [NO_BLOCKS](../interfaces/RPC.RPCSPEC08.API.NO_BLOCKS.md)
- [INVALID_CONTINUATION_TOKEN](../interfaces/RPC.RPCSPEC08.API.INVALID_CONTINUATION_TOKEN.md)
- [TOO_MANY_KEYS_IN_FILTER](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_KEYS_IN_FILTER.md)
- [CONTRACT_ERROR](../interfaces/RPC.RPCSPEC08.API.CONTRACT_ERROR.md)
- [TRANSACTION_EXECUTION_ERROR](../interfaces/RPC.RPCSPEC08.API.TRANSACTION_EXECUTION_ERROR.md)
- [STORAGE_PROOF_NOT_SUPPORTED](../interfaces/RPC.RPCSPEC08.API.STORAGE_PROOF_NOT_SUPPORTED.md)
- [CLASS_ALREADY_DECLARED](../interfaces/RPC.RPCSPEC08.API.CLASS_ALREADY_DECLARED.md)
- [INVALID_TRANSACTION_NONCE](../interfaces/RPC.RPCSPEC08.API.INVALID_TRANSACTION_NONCE.md)
- [INSUFFICIENT_RESOURCES_FOR_VALIDATE](../interfaces/RPC.RPCSPEC08.API.INSUFFICIENT_RESOURCES_FOR_VALIDATE.md)
- [INSUFFICIENT_ACCOUNT_BALANCE](../interfaces/RPC.RPCSPEC08.API.INSUFFICIENT_ACCOUNT_BALANCE.md)
- [VALIDATION_FAILURE](../interfaces/RPC.RPCSPEC08.API.VALIDATION_FAILURE.md)
- [COMPILATION_FAILED](../interfaces/RPC.RPCSPEC08.API.COMPILATION_FAILED.md)
- [CONTRACT_CLASS_SIZE_IS_TOO_LARGE](../interfaces/RPC.RPCSPEC08.API.CONTRACT_CLASS_SIZE_IS_TOO_LARGE.md)
- [NON_ACCOUNT](../interfaces/RPC.RPCSPEC08.API.NON_ACCOUNT.md)
- [DUPLICATE_TX](../interfaces/RPC.RPCSPEC08.API.DUPLICATE_TX.md)
- [COMPILED_CLASS_HASH_MISMATCH](../interfaces/RPC.RPCSPEC08.API.COMPILED_CLASS_HASH_MISMATCH.md)
- [UNSUPPORTED_TX_VERSION](../interfaces/RPC.RPCSPEC08.API.UNSUPPORTED_TX_VERSION.md)
- [UNSUPPORTED_CONTRACT_CLASS_VERSION](../interfaces/RPC.RPCSPEC08.API.UNSUPPORTED_CONTRACT_CLASS_VERSION.md)
- [UNEXPECTED_ERROR](../interfaces/RPC.RPCSPEC08.API.UNEXPECTED_ERROR.md)
- [INVALID_SUBSCRIPTION_ID](../interfaces/RPC.RPCSPEC08.API.INVALID_SUBSCRIPTION_ID.md)
- [TOO_MANY_ADDRESSES_IN_FILTER](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_ADDRESSES_IN_FILTER.md)
- [TOO_MANY_BLOCKS_BACK](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_BLOCKS_BACK.md)
- [COMPILATION_ERROR](../interfaces/RPC.RPCSPEC08.API.COMPILATION_ERROR.md)
...
| :------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `starknet_subscribeNewHeads`                                        | \{ `params`: \{ `block_id?`: [`SUBSCRIPTION_BLOCK_ID`](RPC.RPCSPEC08.API.md#subscription_block_id) } ; `result`: [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) ; `errors`: [`TOO_MANY_BLOCKS_BACK`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_BLOCKS_BACK.md) \| [`BLOCK_NOT_FOUND`](../interfaces/RPC.RPCSPEC08.API.BLOCK_NOT_FOUND.md) ; `events`: [``"starknet_subscriptionNewHeads"``, ``"starknet_subscriptionReorg"``] }                                                                                                                                                                                                                  | New block headers subscription. Creates a WebSocket stream which will fire events for new block headers.                                                                                                         |
| `starknet_subscribeNewHeads.params`                                 | \{ `block_id?`: [`SUBSCRIPTION_BLOCK_ID`](RPC.RPCSPEC08.API.md#subscription_block_id) }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | -                                                                                                                                                                                                                |
| `starknet_subscribeNewHeads.params.block_id?`                       | [`SUBSCRIPTION_BLOCK_ID`](RPC.RPCSPEC08.API.md#subscription_block_id)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | The block to get notifications from, default is latest, limited to 1024 blocks back                                                                                                                              |
| `starknet_subscribeNewHeads.result`                                 | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | -                                                                                                                                                                                                                |
| `starknet_subscribeNewHeads.errors`                                 | [`TOO_MANY_BLOCKS_BACK`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_BLOCKS_BACK.md) \| [`BLOCK_NOT_FOUND`](../interfaces/RPC.RPCSPEC08.API.BLOCK_NOT_FOUND.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | -                                                                                                                                                                                                                |
| `starknet_subscribeNewHeads.events`                                 | [``"starknet_subscriptionNewHeads"``, ``"starknet_subscriptionReorg"``]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | -                                                                                                                                                                                                                |
| `starknet_subscribeEvents`                                          | \{ `params`: \{ `from_address?`: [`ADDRESS`](RPC.RPCSPEC08.API.md#address) ; `keys?`: [`EVENT_KEYS`](RPC.RPCSPEC08.API.md#event_keys) ; `block_id?`: [`SUBSCRIPTION_BLOCK_ID`](RPC.RPCSPEC08.API.md#subscription_block_id) } ; `result`: [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) ; `errors`: [`TOO_MANY_KEYS_IN_FILTER`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_KEYS_IN_FILTER.md) \| [`TOO_MANY_BLOCKS_BACK`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_BLOCKS_BACK.md) \| [`BLOCK_NOT_FOUND`](../interfaces/RPC.RPCSPEC08.API.BLOCK_NOT_FOUND.md) ; `events`: [``"starknet_subscriptionEvents"``, ``"starknet_subscriptionReorg"``] } | New events subscription. Creates a WebSocket stream which will fire events for new Starknet events with applied filters.                                                                                         |
| `starknet_subscribeEvents.params`                                   | \{ `from_address?`: [`ADDRESS`](RPC.RPCSPEC08.API.md#address) ; `keys?`: [`EVENT_KEYS`](RPC.RPCSPEC08.API.md#event_keys) ; `block_id?`: [`SUBSCRIPTION_BLOCK_ID`](RPC.RPCSPEC08.API.md#subscription_block_id) }                                                                                                                                                                                                                                                                                                                                                                                                                                            | -                                                                                                                                                                                                                |
| `starknet_subscribeEvents.params.from_address?`                     | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Filter events by from_address which emitted the event                                                                                                                                                            |
| `starknet_subscribeEvents.params.keys?`                             | [`EVENT_KEYS`](RPC.RPCSPEC08.API.md#event_keys)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | -                                                                                                                                                                                                                |
| `starknet_subscribeEvents.params.block_id?`                         | [`SUBSCRIPTION_BLOCK_ID`](RPC.RPCSPEC08.API.md#subscription_block_id)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | The block to get notifications from, default is latest, limited to 1024 blocks back                                                                                                                              |
| `starknet_subscribeEvents.result`                                   | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | -                                                                                                                                                                                                                |
| `starknet_subscribeEvents.errors`                                   | [`TOO_MANY_KEYS_IN_FILTER`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_KEYS_IN_FILTER.md) \| [`TOO_MANY_BLOCKS_BACK`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_BLOCKS_BACK.md) \| [`BLOCK_NOT_FOUND`](../interfaces/RPC.RPCSPEC08.API.BLOCK_NOT_FOUND.md)                                                                                                                                                                                                                                                                                                                                                                                                    | -                                                                                                                                                                                                                |
| `starknet_subscribeEvents.events`                                   | [``"starknet_subscriptionEvents"``, ``"starknet_subscriptionReorg"``]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | -                                                                                                                                                                                                                |
| `starknet_subscribeTransactionStatus`                               | \{ `params`: \{ `transaction_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) } ; `result`: [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) ; `events`: [``"starknet_subscriptionTransactionStatus"``, ``"starknet_subscriptionReorg"``] }                                                                                                                                                                                                                                                                                                                                                                                                             | New transaction status subscription. Creates a WebSocket stream which at first fires an event with the current known transaction status, followed by events for every transaction status update                  |
| `starknet_subscribeTransactionStatus.params`                        | \{ `transaction_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | -                                                                                                                                                                                                                |
| `starknet_subscribeTransactionStatus.params.transaction_hash`       | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | -                                                                                                                                                                                                                |
| `starknet_subscribeTransactionStatus.result`                        | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | -                                                                                                                                                                                                                |
| `starknet_subscribeTransactionStatus.events`                        | [``"starknet_subscriptionTransactionStatus"``, ``"starknet_subscriptionReorg"``]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | -                                                                                                                                                                                                                |
| `starknet_subscribePendingTransactions`                             | \{ `params`: \{ `transaction_details?`: `Boolean` ; `sender_address?`: [`ADDRESS`](RPC.RPCSPEC08.API.md#address)[] } ; `result`: [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) ; `errors`: [`TOO_MANY_ADDRESSES_IN_FILTER`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_ADDRESSES_IN_FILTER.md) ; `events`: [``"starknet_subscriptionPendingTransactions"``] }                                                                                                                                                                                                                                                                                    | New Pending Transactions subscription. Creates a WebSocket stream which will fire events when a new pending transaction is added. While there is no mempool, this notifies of transactions in the pending block. |
| `starknet_subscribePendingTransactions.params`                      | \{ `transaction_details?`: `Boolean` ; `sender_address?`: [`ADDRESS`](RPC.RPCSPEC08.API.md#address)[] }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | -                                                                                                                                                                                                                |
...
| `starknet_subscribePendingTransactions.params.sender_address?`      | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)[]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Filter transactions to only receive notification from address list                                                                                                                                               |
| `starknet_subscribePendingTransactions.result`                      | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | -                                                                                                                                                                                                                |
| `starknet_subscribePendingTransactions.errors`                      | [`TOO_MANY_ADDRESSES_IN_FILTER`](../interfaces/RPC.RPCSPEC08.API.TOO_MANY_ADDRESSES_IN_FILTER.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | -                                                                                                                                                                                                                |
| `starknet_subscribePendingTransactions.events`                      | [``"starknet_subscriptionPendingTransactions"``]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | -                                                                                                                                                                                                                |
| `starknet_unsubscribe`                                              | \{ `params`: \{ `subscription_id`: [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) } ; `result`: `Boolean` ; `errors`: [`INVALID_SUBSCRIPTION_ID`](../interfaces/RPC.RPCSPEC08.API.INVALID_SUBSCRIPTION_ID.md) }                                                                                                                                                                                                                                                                                                                                                                                                                                 | Close a previously opened ws stream, with the corresponding subscription id                                                                                                                                      |
| `starknet_unsubscribe.params`                                       | \{ `subscription_id`: [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | -                                                                                                                                                                                                                |
| `starknet_unsubscribe.params.subscription_id`                       | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | -                                                                                                                                                                                                                |
| `starknet_unsubscribe.result`                                       | `Boolean`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | -                                                                                                                                                                                                                |
| `starknet_unsubscribe.errors`                                       | [`INVALID_SUBSCRIPTION_ID`](../interfaces/RPC.RPCSPEC08.API.INVALID_SUBSCRIPTION_ID.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | -                                                                                                                                                                                                                |
...
| Name                                       | Type                                                                                                      |
| :----------------------------------------- | :-------------------------------------------------------------------------------------------------------- |
| `starknet_subscriptionReorg`               | [`SubscriptionReorgResponse`](RPC.RPCSPEC08.API.md#subscriptionreorgresponse)                             |
| `starknet_subscriptionNewHeads`            | [`SubscriptionNewHeadsResponse`](RPC.RPCSPEC08.API.md#subscriptionnewheadsresponse)                       |
| `starknet_subscriptionEvents`              | [`SubscriptionEventsResponse`](RPC.RPCSPEC08.API.md#subscriptioneventsresponse)                           |
| `starknet_subscriptionTransactionStatus`   | [`SubscriptionTransactionsStatusResponse`](RPC.RPCSPEC08.API.md#subscriptiontransactionsstatusresponse)   |
| `starknet_subscriptionPendingTransactions` | [`SubscriptionPendingTransactionsResponse`](RPC.RPCSPEC08.API.md#subscriptionpendingtransactionsresponse) |
...
Ƭ **ADDRESS**: [`FELT`](RPC.RPCSPEC08.API.md#felt)
...
Ƭ **SIGNATURE**: [`FELT`](RPC.RPCSPEC08.API.md#felt)[]
...
Ƭ **BLOCK_HASH**: [`FELT`](RPC.RPCSPEC08.API.md#felt)
...
Ƭ **TXN_HASH**: [`FELT`](RPC.RPCSPEC08.API.md#felt)
...
Ƭ **L1_TXN_HASH**: [`NUM_AS_HEX`](RPC.RPCSPEC08.API.md#num_as_hex)
...
Ƭ **CHAIN_ID**: [`NUM_AS_HEX`](RPC.RPCSPEC08.API.md#num_as_hex)
...
Ƭ **STATE_MUTABILITY**: [`STATE_MUTABILITY_VIEW`](RPC.RPCSPEC08.API.md#state_mutability_view) \| [`STATE_MUTABILITY_EXTERNAL`](RPC.RPCSPEC08.API.md#state_mutability_external)
...
Ƭ **FUNCTION_ABI_TYPE**: [`ABI_TYPE_FUNCTION`](RPC.RPCSPEC08.API.md#abi_type_function) \| [`ABI_TYPE_L1_HANDLER`](RPC.RPCSPEC08.API.md#abi_type_l1_handler) \| [`ABI_TYPE_CONSTRUCTOR`](RPC.RPCSPEC08.API.md#abi_type_constructor)
...
Ƭ **TXN_STATUS**: [`STATUS_RECEIVED`](RPC.RPCSPEC08.API.md#status_received) \| [`STATUS_REJECTED`](RPC.RPCSPEC08.API.md#status_rejected) \| [`STATUS_ACCEPTED_ON_L2`](RPC.RPCSPEC08.API.md#status_accepted_on_l2) \| [`STATUS_ACCEPTED_ON_L1`](RPC.RPCSPEC08.API.md#status_accepted_on_l1)
...
Ƭ **SIMULATION_FLAG**: typeof [`SKIP_VALIDATE`](RPC.RPCSPEC08.API.md#skip_validate) \| typeof [`SKIP_FEE_CHARGE`](RPC.RPCSPEC08.API.md#skip_fee_charge)
...
Ƭ **DA_MODE**: [`EDataAvailabilityMode`](RPC.RPCSPEC08.API.md#edataavailabilitymode)
...
Ƭ **TXN_FINALITY_STATUS**: [`STATUS_ACCEPTED_ON_L2`](RPC.RPCSPEC08.API.md#status_accepted_on_l2) \| [`STATUS_ACCEPTED_ON_L1`](RPC.RPCSPEC08.API.md#status_accepted_on_l1)
...
Ƭ **TXN_EXECUTION_STATUS**: [`STATUS_SUCCEEDED`](RPC.RPCSPEC08.API.md#status_succeeded) \| [`STATUS_REVERTED`](RPC.RPCSPEC08.API.md#status_reverted)
...
Ƭ **BLOCK_STATUS**: [`STATUS_PENDING`](RPC.RPCSPEC08.API.md#status_pending) \| [`STATUS_ACCEPTED_ON_L2`](RPC.RPCSPEC08.API.md#status_accepted_on_l2) \| [`STATUS_ACCEPTED_ON_L1`](RPC.RPCSPEC08.API.md#status_accepted_on_l1) \| [`STATUS_REJECTED`](RPC.RPCSPEC08.API.md#status_rejected)
...
Ƭ **BLOCK_TAG**: [`EBlockTag`](RPC.RPCSPEC08.API.md#eblocktag)
...
| Name               | Type                                                          |
| :----------------- | :------------------------------------------------------------ |
| `transaction_hash` | [`TXN_HASH`](RPC.RPCSPEC08.API.md#txn_hash)                   |
| `status`           | [`TXN_STATUS_RESULT`](RPC.RPCSPEC08.API.md#txn_status_result) |
...
| Name                    | Type                                                | Description                                           |
| :---------------------- | :-------------------------------------------------- | :---------------------------------------------------- |
| `starting_block_hash`   | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)     | Hash of the first known block of the orphaned chain   |
| `starting_block_number` | [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number) | Number of the first known block of the orphaned chain |
| `ending_block_hash`     | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)     | The last known block of the orphaned chain            |
| `ending_block_number`   | [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number) | Number of the last known block of the orphaned chain  |
...
| Name              | Type                                                      |
| :---------------- | :-------------------------------------------------------- |
| `subscription_id` | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) |
| `result`          | [`BLOCK_HEADER`](RPC.RPCSPEC08.API.md#block_header)       |
...
| :---------------- | :-------------------------------------------------------- |
| `subscription_id` | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) |
| `result`          | [`EMITTED_EVENT`](RPC.RPCSPEC08.API.md#emitted_event)     |
...
| :---------------- | :-------------------------------------------------------- |
| `subscription_id` | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) |
| `result`          | [`NEW_TXN_STATUS`](RPC.RPCSPEC08.API.md#new_txn_status)   |
...
| :---------------- | :--------------------------------------------------------------------------------------------------- |
| `subscription_id` | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id)                                            |
| `result`          | [`TXN_HASH`](RPC.RPCSPEC08.API.md#txn_hash) \| [`TXN_WITH_HASH`](RPC.RPCSPEC08.API.md#txn_with_hash) |
...
| :---------------- | :-------------------------------------------------------- |
| `subscription_id` | [`SUBSCRIPTION_ID`](RPC.RPCSPEC08.API.md#subscription_id) |
| `result`          | [`REORG_DATA`](RPC.RPCSPEC08.API.md#reorg_data)           |
...
| Name                  | Type                                                    | Description                                                                                                 |
| :-------------------- | :------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------- |
| `events`              | [`EMITTED_EVENT`](RPC.RPCSPEC08.API.md#emitted_event)[] | Returns matching events                                                                                     |
...
Ƭ **EMITTED_EVENT**: [`EVENT`](RPC.RPCSPEC08.API.md#event) & \{ `block_hash`: [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash) ; `block_number`: [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number) ; `transaction_hash`: [`TXN_HASH`](RPC.RPCSPEC08.API.md#txn_hash) }
...
Ƭ **EVENT**: \{ `from_address`: [`ADDRESS`](RPC.RPCSPEC08.API.md#address) } & [`EVENT_CONTENT`](RPC.RPCSPEC08.API.md#event_content)
...
| Name   | Type                                  |
| :----- | :------------------------------------ |
| `keys` | [`FELT`](RPC.RPCSPEC08.API.md#felt)[] |
| `data` | [`FELT`](RPC.RPCSPEC08.API.md#felt)[] |
...
Ƭ **EVENT_KEYS**: [`FELT`](RPC.RPCSPEC08.API.md#felt)[][]
...
| Name          | Type                                            |
| :------------ | :---------------------------------------------- |
| `from_block?` | [`BLOCK_ID`](RPC.RPCSPEC08.API.md#block_id)     |
| `to_block?`   | [`BLOCK_ID`](RPC.RPCSPEC08.API.md#block_id)     |
| `address?`    | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)       |
| `keys?`       | [`EVENT_KEYS`](RPC.RPCSPEC08.API.md#event_keys) |
...
Ƭ **BLOCK_ID**: [`BLOCK_SELECTOR`](RPC.RPCSPEC08.API.md#block_selector) \| [`BLOCK_TAG`](RPC.RPCSPEC08.API.md#block_tag)
...
Ƭ **SUBSCRIPTION_BLOCK_ID**: [`BLOCK_SELECTOR`](RPC.RPCSPEC08.API.md#block_selector) \| [`SUBSCRIPTION_BLOCK_TAG`](RPC.RPCSPEC08.API.md#subscription_block_tag)
...
| Name                  | Type                                                |
| :-------------------- | :-------------------------------------------------- |
| `starting_block_hash` | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)     |
| `starting_block_num`  | [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number) |
| `current_block_hash`  | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)     |
| `current_block_num`   | [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number) |
| `highest_block_hash`  | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)     |
| `highest_block_num`   | [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number) |
...
| Name                  | Type                                |
| :-------------------- | :---------------------------------- |
| `class_hash`          | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
| `compiled_class_hash` | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
...
| :----------------- | :---------------------------------- |
| `class_hash`       | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
| `contract_address` | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
...
| Name               | Type                                      |
| :----------------- | :---------------------------------------- |
| `contract_address` | [`ADDRESS`](RPC.RPCSPEC08.API.md#address) |
...
| Name                          | Type                                                                              |
| :---------------------------- | :-------------------------------------------------------------------------------- |
| `storage_diffs`               | [`CONTRACT_STORAGE_DIFF_ITEM`](RPC.RPCSPEC08.API.md#contract_storage_diff_item)[] |
| `deprecated_declared_classes` | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                             |
| `declared_classes`            | [`NEW_CLASSES`](RPC.RPCSPEC08.API.md#new_classes)[]                               |
| `deployed_contracts`          | [`DEPLOYED_CONTRACT_ITEM`](RPC.RPCSPEC08.API.md#deployed_contract_item)[]         |
| `replaced_classes`            | [`REPLACED_CLASS`](RPC.RPCSPEC08.API.md#replaced_class)[]                         |
| `nonces`                      | [`NONCE_UPDATE`](RPC.RPCSPEC08.API.md#nonce_update)[]                             |
...
| Name         | Type                                            |
| :----------- | :---------------------------------------------- |
| `old_root`   | [`FELT`](RPC.RPCSPEC08.API.md#felt)             |
...
| Name         | Type                                            |
| :----------- | :---------------------------------------------- |
| `block_hash` | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash) |
| `old_root`   | [`FELT`](RPC.RPCSPEC08.API.md#felt)             |
| `new_root`   | [`FELT`](RPC.RPCSPEC08.API.md#felt)             |
| `state_diff` | [`STATE_DIFF`](RPC.RPCSPEC08.API.md#state_diff) |
...
| Name           | Type                                          |
| :------------- | :-------------------------------------------- |
| `transactions` | [`TXN_HASH`](RPC.RPCSPEC08.API.md#txn_hash)[] |
...
| Name           | Type                                                    |
| :------------- | :------------------------------------------------------ |
| `transactions` | [`TXN_WITH_HASH`](RPC.RPCSPEC08.API.md#txn_with_hash)[] |
...
| Name           | Type                                                                                                                   |
| :------------- | :--------------------------------------------------------------------------------------------------------------------- |
| `transactions` | \{ `transaction`: [`TXN`](RPC.RPCSPEC08.API.md#txn) ; `receipt`: [`TXN_RECEIPT`](RPC.RPCSPEC08.API.md#txn_receipt) }[] |
...
| :------------------ | :------------------------------------------------------ |
| `block_hash`        | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)         |
| `parent_hash`       | [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)         |
| `block_number`      | [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number)     |
| `new_root`          | [`FELT`](RPC.RPCSPEC08.API.md#felt)                     |
| `timestamp`         | `number`                                                |
| `sequencer_address` | [`FELT`](RPC.RPCSPEC08.API.md#felt)                     |
| `l1_gas_price`      | [`RESOURCE_PRICE`](RPC.RPCSPEC08.API.md#resource_price) |
| `l2_gas_price`      | [`RESOURCE_PRICE`](RPC.RPCSPEC08.API.md#resource_price) |
| `l1_data_gas_price` | [`RESOURCE_PRICE`](RPC.RPCSPEC08.API.md#resource_price) |
| `l1_da_mode`        | [`L1_DA_MODE`](RPC.RPCSPEC08.API.md#l1_da_mode)         |
...
Ƭ **BLOCK_WITH_TX_HASHES**: \{ `status`: [`BLOCK_STATUS`](RPC.RPCSPEC08.API.md#block_status) } & [`BLOCK_HEADER`](RPC.RPCSPEC08.API.md#block_header) & [`BLOCK_BODY_WITH_TX_HASHES`](RPC.RPCSPEC08.API.md#block_body_with_tx_hashes)
...
Ƭ **BLOCK_WITH_TXS**: \{ `status`: [`BLOCK_STATUS`](RPC.RPCSPEC08.API.md#block_status) } & [`BLOCK_HEADER`](RPC.RPCSPEC08.API.md#block_header) & [`BLOCK_BODY_WITH_TXS`](RPC.RPCSPEC08.API.md#block_body_with_txs)
...
Ƭ **BLOCK_WITH_RECEIPTS**: \{ `status`: [`BLOCK_STATUS`](RPC.RPCSPEC08.API.md#block_status) } & [`BLOCK_HEADER`](RPC.RPCSPEC08.API.md#block_header) & [`BLOCK_BODY_WITH_RECEIPTS`](RPC.RPCSPEC08.API.md#block_body_with_receipts)
...
Ƭ **PENDING_BLOCK_WITH_TX_HASHES**: [`BLOCK_BODY_WITH_TX_HASHES`](RPC.RPCSPEC08.API.md#block_body_with_tx_hashes) & [`PENDING_BLOCK_HEADER`](RPC.RPCSPEC08.API.md#pending_block_header)
...
Ƭ **PENDING_BLOCK_WITH_TXS**: [`BLOCK_BODY_WITH_TXS`](RPC.RPCSPEC08.API.md#block_body_with_txs) & [`PENDING_BLOCK_HEADER`](RPC.RPCSPEC08.API.md#pending_block_header)
...
Ƭ **PENDING_BLOCK_WITH_RECEIPTS**: [`BLOCK_BODY_WITH_RECEIPTS`](RPC.RPCSPEC08.API.md#block_body_with_receipts) & [`PENDING_BLOCK_HEADER`](RPC.RPCSPEC08.API.md#pending_block_header)
...
| Name         | Type                                |
| :----------- | :---------------------------------- |
| `address`    | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
| `class_hash` | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
...
| Name              | Type                                                        | Description                                        |
| :---------------- | :---------------------------------------------------------- | :------------------------------------------------- |
| `address`         | [`FELT`](RPC.RPCSPEC08.API.md#felt)                         | The contract address for which the storage changed |
| `storage_entries` | [`StorageDiffItem`](RPC.RPCSPEC08.API.md#storagediffitem)[] | The changes in the storage of the contract         |
...
| Name    | Type                                | Description                                |
| :------ | :---------------------------------- | :----------------------------------------- |
| `key`   | [`FELT`](RPC.RPCSPEC08.API.md#felt) | The key of the changed value               |
| `value` | [`FELT`](RPC.RPCSPEC08.API.md#felt) | The new value applied to the given address |
...
Ƭ **TXN**: [`INVOKE_TXN`](RPC.RPCSPEC08.API.md#invoke_txn) \| [`L1_HANDLER_TXN`](RPC.RPCSPEC08.API.md#l1_handler_txn) \| [`DECLARE_TXN`](RPC.RPCSPEC08.API.md#declare_txn) \| [`DEPLOY_TXN`](RPC.RPCSPEC08.API.md#deploy_txn) \| [`DEPLOY_ACCOUNT_TXN`](RPC.RPCSPEC08.API.md#deploy_account_txn)
...
Ƭ **TXN_WITH_HASH**: [`TXN`](RPC.RPCSPEC08.API.md#txn) & \{ `transaction_hash`: [`TXN_HASH`](RPC.RPCSPEC08.API.md#txn_hash) }
...
Ƭ **DECLARE_TXN**: [`DECLARE_TXN_V0`](RPC.RPCSPEC08.API.md#declare_txn_v0) \| [`DECLARE_TXN_V1`](RPC.RPCSPEC08.API.md#declare_txn_v1) \| [`DECLARE_TXN_V2`](RPC.RPCSPEC08.API.md#declare_txn_v2) \| [`DECLARE_TXN_V3`](RPC.RPCSPEC08.API.md#declare_txn_v3)
...
| Name             | Type                                                                             |
| :--------------- | :------------------------------------------------------------------------------- |
| `type`           | [`TXN_TYPE_DECLARE`](RPC.RPCSPEC08.API.md#txn_type_declare)                      |
| `sender_address` | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)                                        |
| `max_fee`        | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `version`        | typeof [`V0`](RPC.RPCSPEC08.API.md#v0) \| typeof [`F0`](RPC.RPCSPEC08.API.md#f0) |
| `signature`      | [`SIGNATURE`](RPC.RPCSPEC08.API.md#signature)                                    |
| `class_hash`     | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
...
| `sender_address` | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)                                        |
| `max_fee`        | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `version`        | typeof [`V1`](RPC.RPCSPEC08.API.md#v1) \| typeof [`F1`](RPC.RPCSPEC08.API.md#f1) |
| `signature`      | [`SIGNATURE`](RPC.RPCSPEC08.API.md#signature)                                    |
| `nonce`          | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `class_hash`     | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
...
| `compiled_class_hash` | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `max_fee`             | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `version`             | typeof [`V2`](RPC.RPCSPEC08.API.md#v2) \| typeof [`F2`](RPC.RPCSPEC08.API.md#f2) |
| `signature`           | [`SIGNATURE`](RPC.RPCSPEC08.API.md#signature)                                    |
| `nonce`               | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `class_hash`          | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
...
| `sender_address`               | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)                                        |
| `compiled_class_hash`          | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `version`                      | typeof [`V3`](RPC.RPCSPEC08.API.md#v3) \| typeof [`F3`](RPC.RPCSPEC08.API.md#f3) |
| `signature`                    | [`SIGNATURE`](RPC.RPCSPEC08.API.md#signature)                                    |
| `nonce`                        | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `class_hash`                   | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `resource_bounds`              | [`RESOURCE_BOUNDS_MAPPING`](RPC.RPCSPEC08.API.md#resource_bounds_mapping)        |
| `tip`                          | [`u64`](RPC.RPCSPEC08.API.md#u64)                                                |
| `paymaster_data`               | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                            |
| `account_deployment_data`      | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                            |
| `nonce_data_availability_mode` | [`DA_MODE`](RPC.RPCSPEC08.API.md#da_mode)                                        |
| `fee_data_availability_mode`   | [`DA_MODE`](RPC.RPCSPEC08.API.md#da_mode)                                        |
...
Ƭ **BROADCASTED_TXN**: [`BROADCASTED_INVOKE_TXN`](RPC.RPCSPEC08.API.md#broadcasted_invoke_txn) \| [`BROADCASTED_DECLARE_TXN`](RPC.RPCSPEC08.API.md#broadcasted_declare_txn) \| [`BROADCASTED_DEPLOY_ACCOUNT_TXN`](RPC.RPCSPEC08.API.md#broadcasted_deploy_account_txn)
...
Ƭ **BROADCASTED_INVOKE_TXN**: [`INVOKE_TXN_V3`](RPC.RPCSPEC08.API.md#invoke_txn_v3)
...
Ƭ **BROADCASTED_DEPLOY_ACCOUNT_TXN**: [`DEPLOY_ACCOUNT_TXN_V3`](RPC.RPCSPEC08.API.md#deploy_account_txn_v3)
...
Ƭ **BROADCASTED_DECLARE_TXN**: [`BROADCASTED_DECLARE_TXN_V3`](RPC.RPCSPEC08.API.md#broadcasted_declare_txn_v3)
...
| `signature`                    | [`SIGNATURE`](RPC.RPCSPEC08.API.md#signature)                                    |
| `nonce`                        | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `contract_class`               | [`CONTRACT_CLASS`](RPC.RPCSPEC08.API.md#contract_class)                          |
| `resource_bounds`              | [`RESOURCE_BOUNDS_MAPPING`](RPC.RPCSPEC08.API.md#resource_bounds_mapping)        |
| `tip`                          | [`u64`](RPC.RPCSPEC08.API.md#u64)                                                |
| `paymaster_data`               | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                            |
| `account_deployment_data`      | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                            |
...
Ƭ **DEPLOY_ACCOUNT_TXN**: [`DEPLOY_ACCOUNT_TXN_V1`](RPC.RPCSPEC08.API.md#deploy_account_txn_v1) \| [`DEPLOY_ACCOUNT_TXN_V3`](RPC.RPCSPEC08.API.md#deploy_account_txn_v3)
...
| Name                    | Type                                                                             |
| :---------------------- | :------------------------------------------------------------------------------- |
| `type`                  | [`TXN_TYPE_DEPLOY_ACCOUNT`](RPC.RPCSPEC08.API.md#txn_type_deploy_account)        |
| `max_fee`               | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `version`               | typeof [`V1`](RPC.RPCSPEC08.API.md#v1) \| typeof [`F1`](RPC.RPCSPEC08.API.md#f1) |
| `signature`             | [`SIGNATURE`](RPC.RPCSPEC08.API.md#signature)                                    |
| `nonce`                 | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `contract_address_salt` | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
| `constructor_calldata`  | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                            |
| `class_hash`            | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
...
| Name                    | Type                                                      |
| :---------------------- | :-------------------------------------------------------- |
| `type`                  | [`TXN_TYPE_DEPLOY`](RPC.RPCSPEC08.API.md#txn_type_deploy) |
| `version`               | [`FELT`](RPC.RPCSPEC08.API.md#felt)                       |
| `contract_address_salt` | [`FELT`](RPC.RPCSPEC08.API.md#felt)                       |
| `constructor_calldata`  | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                     |
| `class_hash`            | [`FELT`](RPC.RPCSPEC08.API.md#felt)                       |
...
Ƭ **INVOKE_TXN**: [`INVOKE_TXN_V0`](RPC.RPCSPEC08.API.md#invoke_txn_v0) \| [`INVOKE_TXN_V1`](RPC.RPCSPEC08.API.md#invoke_txn_v1) \| [`INVOKE_TXN_V3`](RPC.RPCSPEC08.API.md#invoke_txn_v3)
...
| `signature`            | [`SIGNATURE`](RPC.RPCSPEC08.API.md#signature)                                    |
| `contract_address`     | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)                                        |
| `entry_point_selector` | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                              |
...
Ƭ **INVOKE_TXN_RECEIPT**: \{ `type`: [`TXN_TYPE_INVOKE`](RPC.RPCSPEC08.API.md#txn_type_invoke) } & [`COMMON_RECEIPT_PROPERTIES`](RPC.RPCSPEC08.API.md#common_receipt_properties)
...
Ƭ **DECLARE_TXN_RECEIPT**: \{ `type`: [`TXN_TYPE_DECLARE`](RPC.RPCSPEC08.API.md#txn_type_declare) } & [`COMMON_RECEIPT_PROPERTIES`](RPC.RPCSPEC08.API.md#common_receipt_properties)
...
Ƭ **DEPLOY_ACCOUNT_TXN_RECEIPT**: \{ `type`: [`TXN_TYPE_DEPLOY_ACCOUNT`](RPC.RPCSPEC08.API.md#txn_type_deploy_account) ; `contract_address`: [`FELT`](RPC.RPCSPEC08.API.md#felt) } & [`COMMON_RECEIPT_PROPERTIES`](RPC.RPCSPEC08.API.md#common_receipt_properties)
...
Ƭ **DEPLOY_TXN_RECEIPT**: \{ `type`: [`TXN_TYPE_DEPLOY`](RPC.RPCSPEC08.API.md#txn_type_deploy) ; `contract_address`: [`FELT`](RPC.RPCSPEC08.API.md#felt) } & [`COMMON_RECEIPT_PROPERTIES`](RPC.RPCSPEC08.API.md#common_receipt_properties)
...
Ƭ **TXN_RECEIPT**: [`INVOKE_TXN_RECEIPT`](RPC.RPCSPEC08.API.md#invoke_txn_receipt) \| [`L1_HANDLER_TXN_RECEIPT`](RPC.RPCSPEC08.API.md#l1_handler_txn_receipt) \| [`DECLARE_TXN_RECEIPT`](RPC.RPCSPEC08.API.md#declare_txn_receipt) \| [`DEPLOY_TXN_RECEIPT`](RPC.RPCSPEC08.API.md#deploy_txn_receipt) \| [`DEPLOY_ACCOUNT_TXN_RECEIPT`](RPC.RPCSPEC08.API.md#deploy_account_txn_receipt)
...
Ƭ **TXN_RECEIPT_WITH_BLOCK_INFO**: [`TXN_RECEIPT`](RPC.RPCSPEC08.API.md#txn_receipt) & \{ `block_hash`: [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash) ; `block_number`: [`BLOCK_NUMBER`](RPC.RPCSPEC08.API.md#block_number) } \| \{ `block_hash`: `never` ; `block_number`: `never` }
...
| Name           | Type                                  |
| :------------- | :------------------------------------ |
| `from_address` | [`FELT`](RPC.RPCSPEC08.API.md#felt)   |
| `to_address`   | [`FELT`](RPC.RPCSPEC08.API.md#felt)   |
| `payload`      | [`FELT`](RPC.RPCSPEC08.API.md#felt)[] |
...
| Name                   | Type                                              |
| :--------------------- | :------------------------------------------------ |
| `from_address`         | [`ETH_ADDRESS`](RPC.RPCSPEC08.API.md#eth_address) |
| `to_address`           | [`ADDRESS`](RPC.RPCSPEC08.API.md#address)         |
| `entry_point_selector` | [`FELT`](RPC.RPCSPEC08.API.md#felt)               |
| `payload`              | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]             |
...
| Name                               | Type                                                                                                                                                                                                                                                    |
| :--------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `sierra_program`                   | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                                                                                                                                                                                                   |
| `contract_class_version`           | `string`                                                                                                                                                                                                                                                |
| `entry_points_by_type`             | \{ `CONSTRUCTOR`: [`SIERRA_ENTRY_POINT`](RPC.RPCSPEC08.API.md#sierra_entry_point)[] ; `EXTERNAL`: [`SIERRA_ENTRY_POINT`](RPC.RPCSPEC08.API.md#sierra_entry_point)[] ; `L1_HANDLER`: [`SIERRA_ENTRY_POINT`](RPC.RPCSPEC08.API.md#sierra_entry_point)[] } |
| `entry_points_by_type.CONSTRUCTOR` | [`SIERRA_ENTRY_POINT`](RPC.RPCSPEC08.API.md#sierra_entry_point)[]                                                                                                                                                                                       |
| `entry_points_by_type.EXTERNAL`    | [`SIERRA_ENTRY_POINT`](RPC.RPCSPEC08.API.md#sierra_entry_point)[]                                                                                                                                                                                       |
| `entry_points_by_type.L1_HANDLER`  | [`SIERRA_ENTRY_POINT`](RPC.RPCSPEC08.API.md#sierra_entry_point)[]                                                                                                                                                                                       |
| `abi`                              | `string`                                                                                                                                                                                                                                                |
...
| :--------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `program`                          | `string`                                                                                                                                                                                                                                                                                                            |
| `entry_points_by_type`             | \{ `CONSTRUCTOR`: [`DEPRECATED_CAIRO_ENTRY_POINT`](RPC.RPCSPEC08.API.md#deprecated_cairo_entry_point)[] ; `EXTERNAL`: [`DEPRECATED_CAIRO_ENTRY_POINT`](RPC.RPCSPEC08.API.md#deprecated_cairo_entry_point)[] ; `L1_HANDLER`: [`DEPRECATED_CAIRO_ENTRY_POINT`](RPC.RPCSPEC08.API.md#deprecated_cairo_entry_point)[] } |
| `entry_points_by_type.CONSTRUCTOR` | [`DEPRECATED_CAIRO_ENTRY_POINT`](RPC.RPCSPEC08.API.md#deprecated_cairo_entry_point)[]                                                                                                                                                                                                                               |
| `entry_points_by_type.EXTERNAL`    | [`DEPRECATED_CAIRO_ENTRY_POINT`](RPC.RPCSPEC08.API.md#deprecated_cairo_entry_point)[]                                                                                                                                                                                                                               |
| `entry_points_by_type.L1_HANDLER`  | [`DEPRECATED_CAIRO_ENTRY_POINT`](RPC.RPCSPEC08.API.md#deprecated_cairo_entry_point)[]                                                                                                                                                                                                                               |
| `abi`                              | [`CONTRACT_ABI`](RPC.RPCSPEC08.API.md#contract_abi)                                                                                                                                                                                                                                                                 |
...
| Name       | Type                                            | Description                                                      |
| :--------- | :---------------------------------------------- | :--------------------------------------------------------------- |
| `offset`   | [`NUM_AS_HEX`](RPC.RPCSPEC08.API.md#num_as_hex) | "The offset of the entry point in the program"                   |
| `selector` | [`FELT`](RPC.RPCSPEC08.API.md#felt)             | A unique identifier of the entry point (function) in the program |
...
Ƭ **CONTRACT_ABI**: readonly [`CONTRACT_ABI_ENTRY`](RPC.RPCSPEC08.API.md#contract_abi_entry)[]
...
Ƭ **CONTRACT_ABI_ENTRY**: [`FUNCTION_ABI_ENTRY`](RPC.RPCSPEC08.API.md#function_abi_entry) \| [`EVENT_ABI_ENTRY`](RPC.RPCSPEC08.API.md#event_abi_entry) \| [`STRUCT_ABI_ENTRY`](RPC.RPCSPEC08.API.md#struct_abi_entry)
...
| Name      | Type                                                      | Description     |
| :-------- | :-------------------------------------------------------- | :-------------- |
| `type`    | [`STRUCT_ABI_TYPE`](RPC.RPCSPEC08.API.md#struct_abi_type) | Struct ABI type |
| `name`    | `string`                                                  | Struct name     |
| `size`    | `number`                                                  | -               |
| `members` | [`STRUCT_MEMBER`](RPC.RPCSPEC08.API.md#struct_member)[]   | -               |
...
Ƭ **STRUCT_MEMBER**: [`TYPED_PARAMETER`](RPC.RPCSPEC08.API.md#typed_parameter) & \{ `offset`: `number` }
...
| Name   | Type                                                        | Description    |
| :----- | :---------------------------------------------------------- | :------------- |
| `type` | [`EVENT_ABI_TYPE`](RPC.RPCSPEC08.API.md#event_abi_type)     | Event ABI type |
| `name` | `string`                                                    | Event name     |
| `keys` | [`TYPED_PARAMETER`](RPC.RPCSPEC08.API.md#typed_parameter)[] | -              |
| `data` | [`TYPED_PARAMETER`](RPC.RPCSPEC08.API.md#typed_parameter)[] | -              |
...
Ƭ **FUNCTION_STATE_MUTABILITY**: [`STATE_MUTABILITY_VIEW`](RPC.RPCSPEC08.API.md#state_mutability_view)
...
| Name               | Type                                                                          | Description               |
| :----------------- | :---------------------------------------------------------------------------- | :------------------------ |
| `type`             | [`FUNCTION_ABI_TYPE`](RPC.RPCSPEC08.API.md#function_abi_type)                 | Function ABI type         |
| `name`             | `string`                                                                      | Function name             |
| `inputs`           | [`TYPED_PARAMETER`](RPC.RPCSPEC08.API.md#typed_parameter)[]                   | Typed parameter           |
| `outputs`          | [`TYPED_PARAMETER`](RPC.RPCSPEC08.API.md#typed_parameter)[]                   | Typed parameter           |
| `stateMutability?` | [`FUNCTION_STATE_MUTABILITY`](RPC.RPCSPEC08.API.md#function_state_mutability) | Function state mutability |
...
Ƭ **SIMULATION_FLAG_FOR_ESTIMATE_FEE**: typeof [`SKIP_VALIDATE`](RPC.RPCSPEC08.API.md#skip_validate)
...
Ƭ **PRICE_UNIT**: [`PRICE_UNIT_WEI`](RPC.RPCSPEC08.API.md#price_unit_wei) \| [`PRICE_UNIT_FRI`](RPC.RPCSPEC08.API.md#price_unit_fri)
...
| `overall_fee`          | `number`                                        | -                                                                                                                                                        |
| `unit`                 | [`PRICE_UNIT`](RPC.RPCSPEC08.API.md#price_unit) | -                                                                                                                                                        |
...
| Name     | Type                                            |
| :------- | :---------------------------------------------- |
| `amount` | [`FELT`](RPC.RPCSPEC08.API.md#felt)             |
| `unit`   | [`PRICE_UNIT`](RPC.RPCSPEC08.API.md#price_unit) |
...
| Name          | Type                                                      | Description                                                          |
| :------------ | :-------------------------------------------------------- | :------------------------------------------------------------------- |
| `l1_gas`      | [`RESOURCE_BOUNDS`](RPC.RPCSPEC08.API.md#resource_bounds) | The max amount and max price per unit of L1 gas used in this tx      |
| `l1_data_gas` | [`RESOURCE_BOUNDS`](RPC.RPCSPEC08.API.md#resource_bounds) | The max amount and max price per unit of L1 blob gas used in this tx |
| `l2_gas`      | [`RESOURCE_BOUNDS`](RPC.RPCSPEC08.API.md#resource_bounds) | The max amount and max price per unit of L2 gas used in this tx      |
...
| Name                 | Type                                |
| :------------------- | :---------------------------------- |
| `max_amount`         | [`u64`](RPC.RPCSPEC08.API.md#u64)   |
| `max_price_per_unit` | [`u128`](RPC.RPCSPEC08.API.md#u128) |
...
| Name           | Type                                |
| :------------- | :---------------------------------- |
| `price_in_fri` | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
| `price_in_wei` | [`FELT`](RPC.RPCSPEC08.API.md#felt) |
...
| Name    | Type                                | Description                 |
| :------ | :---------------------------------- | :-------------------------- |
| `left`  | [`FELT`](RPC.RPCSPEC08.API.md#felt) | the hash of the left child  |
| `right` | [`FELT`](RPC.RPCSPEC08.API.md#felt) | the hash of the right child |
...
| Name     | Type                                            | Description                                                                                                                            |
| :------- | :---------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------- |
| `path`   | [`NUM_AS_HEX`](RPC.RPCSPEC08.API.md#num_as_hex) | an integer whose binary representation represents the path from the current node to its highest non-zero descendant (bounded by 2^251) |
| `length` | `number`                                        | the length of the path (bounded by 251)                                                                                                |
| `child`  | [`FELT`](RPC.RPCSPEC08.API.md#felt)             | the hash of the unique non-zero maximal-height descendant node                                                                         |
...
Ƭ **NODE_HASH_TO_NODE_MAPPING**: \{ `node_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `node`: [`MERKLE_NODE`](RPC.RPCSPEC08.API.md#merkle_node) }[]
...
Ƭ **CONTRACT_EXECUTION_ERROR**: [`CONTRACT_EXECUTION_ERROR_INNER`](RPC.RPCSPEC08.API.md#contract_execution_error_inner)
...
Ƭ **CONTRACT_EXECUTION_ERROR_INNER**: \{ `contract_address`: [`ADDRESS`](RPC.RPCSPEC08.API.md#address) ; `class_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `selector`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `error`: [`CONTRACT_EXECUTION_ERROR`](RPC.RPCSPEC08.API.md#contract_execution_error) } \| `string`
...
Ƭ **TRANSACTION_TRACE**: [`INVOKE_TXN_TRACE`](RPC.RPCSPEC08.API.md#invoke_txn_trace) \| [`DECLARE_TXN_TRACE`](RPC.RPCSPEC08.API.md#declare_txn_trace) \| [`DEPLOY_ACCOUNT_TXN_TRACE`](RPC.RPCSPEC08.API.md#deploy_account_txn_trace) \| [`L1_HANDLER_TXN_TRACE`](RPC.RPCSPEC08.API.md#l1_handler_txn_trace)
...
| :------------------------- | :------------------------------------------------------------------------ |
| `type`                     | [`TXN_TYPE_DEPLOY_ACCOUNT`](RPC.RPCSPEC08.API.md#txn_type_deploy_account) |
| `constructor_invocation`   | [`FUNCTION_INVOCATION`](RPC.RPCSPEC08.API.md#function_invocation)         |
| `validate_invocation?`     | [`FUNCTION_INVOCATION`](RPC.RPCSPEC08.API.md#function_invocation)         |
| `fee_transfer_invocation?` | [`FUNCTION_INVOCATION`](RPC.RPCSPEC08.API.md#function_invocation)         |
| `state_diff?`              | [`STATE_DIFF`](RPC.RPCSPEC08.API.md#state_diff)                           |
| `execution_resources`      | [`EXECUTION_RESOURCES`](RPC.RPCSPEC08.API.md#execution_resources)         |
...
Ƭ **NESTED_CALL**: [`FUNCTION_INVOCATION`](RPC.RPCSPEC08.API.md#function_invocation)
...
Ƭ **FUNCTION_INVOCATION**: [`FUNCTION_CALL`](RPC.RPCSPEC08.API.md#function_call) & \{ `caller_address`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `class_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `entry_point_type`: [`ENTRY_POINT_TYPE`](RPC.RPCSPEC08.API.md#entry_point_type) ; `call_type`: [`CALL_TYPE`](RPC.RPCSPEC08.API.md#call_type) ; `result`: [`FELT`](RPC.RPCSPEC08.API.md#felt)[] ; `calls`: [`NESTED_CALL`](RPC.RPCSPEC08.API.md#nested_call)[] ; `events`: [`ORDERED_EVENT`](RPC.RPCSPEC08.API.md#ordered_event)[] ; `messages`: [`ORDERED_MESSAGE`](RPC.RPCSPEC08.API.md#ordered_message)[] ; `execution_resources`: [`INNER_CALL_EXECUTION_RESOURCES`](RPC.RPCSPEC08.API.md#inner_call_execution_resources) ; `is_reverted`: `boolean` }
...
| :------ | :------------------------------------ |
| `order` | `number`                              |
| `event` | [`EVENT`](RPC.RPCSPEC08.API.md#event) |
...
| :-------- | :-------------------------------------------- |
| `order`   | `number`                                      |
| `message` | [`MSG_TO_L1`](RPC.RPCSPEC08.API.md#msg_to_l1) |
...
| Name                | Type                                                                | Description                                                                                     |
| :------------------ | :------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------- |
| `finality_status`   | [`TXN_STATUS`](RPC.RPCSPEC08.API.md#txn_status)                     | -                                                                                               |
| `execution_status?` | [`TXN_EXECUTION_STATUS`](RPC.RPCSPEC08.API.md#txn_execution_status) | -                                                                                               |
...
| :----------------- | :---------------------------------------- |
| `contract_address` | [`ADDRESS`](RPC.RPCSPEC08.API.md#address) |
| `storage_keys`     | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]     |
...
| Name                | Type                                                          |
| :------------------ | :------------------------------------------------------------ |
| `transaction_trace` | [`TRANSACTION_TRACE`](RPC.RPCSPEC08.API.md#transaction_trace) |
| `fee_estimation`    | [`FEE_ESTIMATE`](RPC.RPCSPEC08.API.md#fee_estimate)           |
...
Ƭ **SimulateTransactionResponse**: [`SimulateTransaction`](RPC.RPCSPEC08.API.md#simulatetransaction)[]
...
Ƭ **FeeEstimate**: [`FEE_ESTIMATE`](RPC.RPCSPEC08.API.md#fee_estimate)
...
Ƭ **TransactionWithHash**: [`TXN_WITH_HASH`](RPC.RPCSPEC08.API.md#txn_with_hash)
...
Ƭ **BlockTransactionsTraces**: \{ `transaction_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `trace_root`: [`TRANSACTION_TRACE`](RPC.RPCSPEC08.API.md#transaction_trace) }[]
...
Ƭ **Syncing**: `false` \| [`SYNC_STATUS`](RPC.RPCSPEC08.API.md#sync_status)
...
Ƭ **Events**: [`EVENTS_CHUNK`](RPC.RPCSPEC08.API.md#events_chunk)
...
Ƭ **EmittedEvent**: [`EMITTED_EVENT`](RPC.RPCSPEC08.API.md#emitted_event)
...
Ƭ **Event**: [`EVENT`](RPC.RPCSPEC08.API.md#event)
...
Ƭ **L1L2MessagesStatus**: [`L1L2MessageStatus`](RPC.RPCSPEC08.API.md#l1l2messagestatus)[]
...
| Name                                   | Type                                                                                                                                                                                                                                                                                |
| :------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `classes_proof`                        | [`NODE_HASH_TO_NODE_MAPPING`](RPC.RPCSPEC08.API.md#node_hash_to_node_mapping)                                                                                                                                                                                                       |
| `contracts_proof`                      | \{ `nodes`: [`NODE_HASH_TO_NODE_MAPPING`](RPC.RPCSPEC08.API.md#node_hash_to_node_mapping) ; `contract_leaves_data`: \{ `nonce`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `class_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `storage_root`: [`FELT`](RPC.RPCSPEC08.API.md#felt) }[] } |
| `contracts_proof.nodes`                | [`NODE_HASH_TO_NODE_MAPPING`](RPC.RPCSPEC08.API.md#node_hash_to_node_mapping)                                                                                                                                                                                                       |
| `contracts_proof.contract_leaves_data` | \{ `nonce`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `class_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `storage_root`: [`FELT`](RPC.RPCSPEC08.API.md#felt) }[]                                                                                                                       |
| `contracts_storage_proofs`             | [`NODE_HASH_TO_NODE_MAPPING`](RPC.RPCSPEC08.API.md#node_hash_to_node_mapping)[]                                                                                                                                                                                                     |
| `global_roots`                         | \{ `contracts_tree_root`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `classes_tree_root`: [`FELT`](RPC.RPCSPEC08.API.md#felt) ; `block_hash`: [`FELT`](RPC.RPCSPEC08.API.md#felt) }                                                                                                      |
| `global_roots.contracts_tree_root`     | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                                                                                                                                                                                                                                 |
| `global_roots.classes_tree_root`       | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                                                                                                                                                                                                                                 |
| `global_roots.block_hash`              | [`FELT`](RPC.RPCSPEC08.API.md#felt)                                                                                                                                                                                                                                                 |
...
Ƭ **CompiledCasm**: [`CASM_COMPILED_CONTRACT_CLASS`](RPC.RPCSPEC08.API.md#casm_compiled_contract_class)
...
Ƭ **ContractAddress**: [`ADDRESS`](RPC.RPCSPEC08.API.md#address)
...
Ƭ **Felt**: [`FELT`](RPC.RPCSPEC08.API.md#felt)
...
Ƭ **Nonce**: [`FELT`](RPC.RPCSPEC08.API.md#felt)
...
Ƭ **TransactionHash**: [`TXN_HASH`](RPC.RPCSPEC08.API.md#txn_hash)
...
Ƭ **TransactionTrace**: [`TRANSACTION_TRACE`](RPC.RPCSPEC08.API.md#transaction_trace)
...
Ƭ **BlockHash**: [`BLOCK_HASH`](RPC.RPCSPEC08.API.md#block_hash)
...
Ƭ **TransactionReceipt**: [`TXN_RECEIPT_WITH_BLOCK_INFO`](RPC.RPCSPEC08.API.md#txn_receipt_with_block_info)
...
Ƭ **EventFilter**: [`EVENT_FILTER`](RPC.RPCSPEC08.API.md#event_filter) & [`RESULT_PAGE_REQUEST`](RPC.RPCSPEC08.API.md#result_page_request)
...
Ƭ **SimulationFlags**: [`SIMULATION_FLAG`](RPC.RPCSPEC08.API.md#simulation_flag)[]
...
Ƭ **L1Message**: [`MSG_FROM_L1`](RPC.RPCSPEC08.API.md#msg_from_l1)
...
Ƭ **BaseTransaction**: [`BROADCASTED_TXN`](RPC.RPCSPEC08.API.md#broadcasted_txn)
...
Ƭ **ChainId**: [`CHAIN_ID`](RPC.RPCSPEC08.API.md#chain_id)
...
Ƭ **Transaction**: [`TXN`](RPC.RPCSPEC08.API.md#txn)
...
Ƭ **TransactionStatus**: [`TXN_STATUS_RESULT`](RPC.RPCSPEC08.API.md#txn_status_result)
...
Ƭ **ResourceBounds**: [`RESOURCE_BOUNDS_MAPPING`](RPC.RPCSPEC08.API.md#resource_bounds_mapping)
...
Ƭ **FeePayment**: [`FEE_PAYMENT`](RPC.RPCSPEC08.API.md#fee_payment)
...
Ƭ **PriceUnit**: [`PRICE_UNIT`](RPC.RPCSPEC08.API.md#price_unit)
...
| Name               | Type                                            | Description                                                         |
| :----------------- | :---------------------------------------------- | :------------------------------------------------------------------ |
| `transaction_hash` | [`TXN_HASH`](RPC.RPCSPEC08.API.md#txn_hash)     | l1_handler tx hash                                                  |
| `finality_status`  | [`TXN_STATUS`](RPC.RPCSPEC08.API.md#txn_status) | finality status of the L1 -> L2 messages sent by the l1 transaction |
...
Ƭ **StorageDiffs**: [`CONTRACT_STORAGE_DIFF_ITEM`](RPC.RPCSPEC08.API.md#contract_storage_diff_item)[]
...
Ƭ **DeprecatedDeclaredClasses**: [`FELT`](RPC.RPCSPEC08.API.md#felt)[]
...
Ƭ **NonceUpdates**: [`NONCE_UPDATE`](RPC.RPCSPEC08.API.md#nonce_update)[]
...
Ƭ **ReplacedClasses**: [`REPLACED_CLASS`](RPC.RPCSPEC08.API.md#replaced_class)[]
...
Ƭ **L1_DA_MODE**: typeof [`L1_DA_MODE`](RPC.RPCSPEC08.API.md#l1_da_mode-1)[keyof typeof [`L1_DA_MODE`](RPC.RPCSPEC08.API.md#l1_da_mode-1)]
...
Ƭ **CALL_TYPE**: typeof [`CALL_TYPE`](RPC.RPCSPEC08.API.md#call_type-1)[keyof typeof [`CALL_TYPE`](RPC.RPCSPEC08.API.md#call_type-1)]
...
Ƭ **ETransactionType**: typeof [`ETransactionType`](RPC.RPCSPEC08.API.md#etransactiontype-1)[keyof typeof [`ETransactionType`](RPC.RPCSPEC08.API.md#etransactiontype-1)]
...
Ƭ **ESimulationFlag**: typeof [`ESimulationFlag`](RPC.RPCSPEC08.API.md#esimulationflag-1)[keyof typeof [`ESimulationFlag`](RPC.RPCSPEC08.API.md#esimulationflag-1)]
...
Ƭ **ETransactionStatus**: typeof [`ETransactionStatus`](RPC.RPCSPEC08.API.md#etransactionstatus-1)[keyof typeof [`ETransactionStatus`](RPC.RPCSPEC08.API.md#etransactionstatus-1)]
...
Ƭ **ETransactionFinalityStatus**: typeof [`ETransactionFinalityStatus`](RPC.RPCSPEC08.API.md#etransactionfinalitystatus-1)[keyof typeof [`ETransactionFinalityStatus`](RPC.RPCSPEC08.API.md#etransactionfinalitystatus-1)]
...
Ƭ **ETransactionExecutionStatus**: typeof [`ETransactionExecutionStatus`](RPC.RPCSPEC08.API.md#etransactionexecutionstatus-1)[keyof typeof [`ETransactionExecutionStatus`](RPC.RPCSPEC08.API.md#etransactionexecutionstatus-1)]
...
Ƭ **EBlockTag**: typeof [`EBlockTag`](RPC.RPCSPEC08.API.md#eblocktag-1)[keyof typeof [`EBlockTag`](RPC.RPCSPEC08.API.md#eblocktag-1)]
...
Ƭ **EDataAvailabilityMode**: typeof [`EDataAvailabilityMode`](RPC.RPCSPEC08.API.md#edataavailabilitymode-1)[keyof typeof [`EDataAvailabilityMode`](RPC.RPCSPEC08.API.md#edataavailabilitymode-1)]
...
Ƭ **EDAMode**: typeof [`EDAMode`](RPC.RPCSPEC08.API.md#edamode-1)[keyof typeof [`EDAMode`](RPC.RPCSPEC08.API.md#edamode-1)]
...
Ƭ **ETransactionVersion**: typeof [`ETransactionVersion`](RPC.RPCSPEC08.API.md#etransactionversion-1)[keyof typeof [`ETransactionVersion`](RPC.RPCSPEC08.API.md#etransactionversion-1)]
...
Ƭ **ETransactionVersion2**: typeof [`ETransactionVersion2`](RPC.RPCSPEC08.API.md#etransactionversion2-1)[keyof typeof [`ETransactionVersion2`](RPC.RPCSPEC08.API.md#etransactionversion2-1)]
...
Ƭ **ETransactionVersion3**: typeof [`ETransactionVersion3`](RPC.RPCSPEC08.API.md#etransactionversion3-1)[keyof typeof [`ETransactionVersion3`](RPC.RPCSPEC08.API.md#etransactionversion3-1)]
...
| Name                               | Type                                                                                                                                                                                                                                        | Description                                                                                                                |
| :--------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------- |
| `entry_points_by_type`             | \{ `CONSTRUCTOR`: [`CASM_ENTRY_POINT`](RPC.RPCSPEC08.API.md#casm_entry_point)[] ; `EXTERNAL`: [`CASM_ENTRY_POINT`](RPC.RPCSPEC08.API.md#casm_entry_point)[] ; `L1_HANDLER`: [`CASM_ENTRY_POINT`](RPC.RPCSPEC08.API.md#casm_entry_point)[] } | -                                                                                                                          |
| `entry_points_by_type.CONSTRUCTOR` | [`CASM_ENTRY_POINT`](RPC.RPCSPEC08.API.md#casm_entry_point)[]                                                                                                                                                                               | -                                                                                                                          |
| `entry_points_by_type.EXTERNAL`    | [`CASM_ENTRY_POINT`](RPC.RPCSPEC08.API.md#casm_entry_point)[]                                                                                                                                                                               | -                                                                                                                          |
| `entry_points_by_type.L1_HANDLER`  | [`CASM_ENTRY_POINT`](RPC.RPCSPEC08.API.md#casm_entry_point)[]                                                                                                                                                                               | -                                                                                                                          |
| `bytecode`                         | [`FELT`](RPC.RPCSPEC08.API.md#felt)[]                                                                                                                                                                                                       | -                                                                                                                          |
| `prime`                            | [`NUM_AS_HEX`](RPC.RPCSPEC08.API.md#num_as_hex)                                                                                                                                                                                             | -                                                                                                                          |
| `compiler_version`                 | `string`                                                                                                                                                                                                                                    | -                                                                                                                          |
| `hints`                            | [`number` \| [`HINT`](RPC.RPCSPEC08.API.md#hint)[], `number` \| [`HINT`](RPC.RPCSPEC08.API.md#hint)[]][]                                                                                                                                    | Array of 2-tuple of pc value and an array of hints to execute.                                                             |
...
| Name    | Type                                      |
| :------ | :---------------------------------------- |
| `Deref` | [`CellRef`](RPC.RPCSPEC08.API.md#cellref) |
...
| Name          | Type                                                    | Description               |
| :------------ | :------------------------------------------------------ | :------------------------ |
| `DoubleDeref` | [[`CellRef`](RPC.RPCSPEC08.API.md#cellref) \| `number`] | A (CellRef, offset) tuple |
...
| Name        | Type                                            |
| :---------- | :---------------------------------------------- |
| `Immediate` | [`NUM_AS_HEX`](RPC.RPCSPEC08.API.md#num_as_hex) |
...
| Name       | Type                                                                                                                                                                         |
| :--------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BinOp`    | \{ `op`: `"Add"` \| `"Mul"` ; `a`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `b`: [`Deref`](RPC.RPCSPEC08.API.md#deref) \| [`Immediate`](RPC.RPCSPEC08.API.md#immediate) } |
| `BinOp.op` | `"Add"` \| `"Mul"`                                                                                                                                                           |
| `BinOp.a`  | [`CellRef`](RPC.RPCSPEC08.API.md#cellref)                                                                                                                                    |
| `BinOp.b`  | [`Deref`](RPC.RPCSPEC08.API.md#deref) \| [`Immediate`](RPC.RPCSPEC08.API.md#immediate)                                                                                       |
...
Ƭ **ResOperand**: [`Deref`](RPC.RPCSPEC08.API.md#deref) \| [`DoubleDeref`](RPC.RPCSPEC08.API.md#doublederef) \| [`Immediate`](RPC.RPCSPEC08.API.md#immediate) \| [`BinOp`](RPC.RPCSPEC08.API.md#binop)
...
Ƭ **HINT**: [`DEPRECATED_HINT`](RPC.RPCSPEC08.API.md#deprecated_hint) \| [`CORE_HINT`](RPC.RPCSPEC08.API.md#core_hint) \| [`STARKNET_HINT`](RPC.RPCSPEC08.API.md#starknet_hint)
...
Ƭ **DEPRECATED_HINT**: `"AssertCurrentAccessIndicesIsEmpty"` \| `"AssertAllKeysUsed"` \| `"AssertLeAssertThirdArcExcluded"` \| \{ `AssertAllAccessesUsed`: \{ `n_used_accesses`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `AssertLtAssertValidInput`: \{ `a`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `b`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `Felt252DictRead`: \{ `dict_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `key`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `value_dst`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `Felt252DictWrite`: \{ `dict_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `key`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `value`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } }
...
Ƭ **CORE_HINT**: \{ `AllocSegment`: \{ `dst`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `TestLessThan`: \{ `lhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `rhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dst`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `TestLessThanOrEqual`: \{ `lhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `rhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dst`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `TestLessThanOrEqualAddress`: \{ `lhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `rhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dst`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `WideMul128`: \{ `lhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `rhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `high`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `low`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `DivMod`: \{ `lhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `rhs`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `quotient`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `remainder`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `Uint256DivMod`: \{ `dividend0`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dividend1`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `divisor0`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `divisor1`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `quotient0`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `quotient1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `remainder0`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `remainder1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `Uint512DivModByUint256`: \{ `dividend0`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dividend1`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dividend2`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dividend3`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `divisor0`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `divisor1`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `quotient0`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `quotient1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `quotient2`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `quotient3`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `remainder0`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `remainder1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `SquareRoot`: \{ `value`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dst`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `Uint256SquareRoot`: \{ `value_low`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `value_high`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `sqrt0`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `sqrt1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `remainder_low`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `remainder_high`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `sqrt_mul_2_minus_remainder_ge_u128`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `LinearSplit`: \{ `value`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `scalar`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `max_x`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `x`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `y`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `AllocFelt252Dict`: \{ `segment_arena_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `Felt252DictEntryInit`: \{ `dict_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `key`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `Felt252DictEntryUpdate`: \{ `dict_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `value`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `GetSegmentArenaIndex`: \{ `dict_end_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dict_index`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `InitSquashData`: \{ `dict_accesses`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `ptr_diff`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `n_accesses`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `big_keys`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `first_key`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `GetCurrentAccessIndex`: \{ `range_check_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `ShouldSkipSquashLoop`: \{ `should_skip_loop`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `GetCurrentAccessDelta`: \{ `index_delta_minus1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `ShouldContinueSquashLoop`: \{ `should_continue`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `GetNextDictKey`: \{ `next_key`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `AssertLeFindSmallArcs`: \{ `range_check_ptr`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `a`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `b`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `AssertLeIsFirstArcExcluded`: \{ `skip_exclude_a_flag`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `AssertLeIsSecondArcExcluded`: \{ `skip_exclude_b_minus_a`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `RandomEcPoint`: \{ `x`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `y`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `FieldSqrt`: \{ `val`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `sqrt`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `DebugPrint`: \{ `start`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `end`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `AllocConstantSize`: \{ `size`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `dst`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `U256InvModN`: \{ `b0`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `b1`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `n0`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `n1`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `g0_or_no_inv`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `g1_option`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `s_or_r0`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `s_or_r1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `t_or_k0`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `t_or_k1`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } } \| \{ `EvalCircuit`: \{ `n_add_mods`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `add_mod_builtin`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `n_mul_mods`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `mul_mod_builtin`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } }
...
Ƭ **STARKNET_HINT**: \{ `SystemCall`: \{ `system`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) } } \| \{ `Cheatcode`: \{ `selector`: [`NUM_AS_HEX`](RPC.RPCSPEC08.API.md#num_as_hex) ; `input_start`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `input_end`: [`ResOperand`](RPC.RPCSPEC08.API.md#resoperand) ; `output_start`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) ; `output_end`: [`CellRef`](RPC.RPCSPEC08.API.md#cellref) } }
