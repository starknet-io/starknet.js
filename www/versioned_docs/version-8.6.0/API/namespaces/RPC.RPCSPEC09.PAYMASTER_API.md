---
id: 'RPC.RPCSPEC09.PAYMASTER_API'
title: 'Namespace: PAYMASTER_API'
sidebar_label: 'PAYMASTER_API'
custom_edit_url: null
---

[RPC](RPC.md).[RPCSPEC09](RPC.RPCSPEC09.md).PAYMASTER_API

## Interfaces

- [INVALID_ADDRESS](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.INVALID_ADDRESS.md)
- [TOKEN_NOT_SUPPORTED](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.TOKEN_NOT_SUPPORTED.md)
- [INVALID_SIGNATURE](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.INVALID_SIGNATURE.md)
- [MAX_AMOUNT_TOO_LOW](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.MAX_AMOUNT_TOO_LOW.md)
- [CLASS_HASH_NOT_SUPPORTED](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.CLASS_HASH_NOT_SUPPORTED.md)
- [TRANSACTION_EXECUTION_ERROR](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.TRANSACTION_EXECUTION_ERROR.md)
- [INVALID_TIME_BOUNDS](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.INVALID_TIME_BOUNDS.md)
- [INVALID_DEPLOYMENT_DATA](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.INVALID_DEPLOYMENT_DATA.md)
- [INVALID_CLASS_HASH](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.INVALID_CLASS_HASH.md)
- [INVALID_ID](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.INVALID_ID.md)
- [UNKNOWN_ERROR](../interfaces/RPC.RPCSPEC09.PAYMASTER_API.UNKNOWN_ERROR.md)
...
Ƭ **TRACKING_ID**: [`FELT`](RPC.RPCSPEC09.API.md#felt)
...
| :----------- | :---------------------------------------------------------------------------------- |
| `type`       | `"deploy"`                                                                          |
| `deployment` | [`ACCOUNT_DEPLOYMENT_DATA`](RPC.RPCSPEC09.PAYMASTER_API.md#account_deployment_data) |
...
| :------- | :---------------------------------------------------------- |
| `type`   | `"invoke"`                                                  |
| `invoke` | [`USER_INVOKE`](RPC.RPCSPEC09.PAYMASTER_API.md#user_invoke) |
...
| Name           | Type                                            |
| :------------- | :---------------------------------------------- |
| `user_address` | [`ADDRESS`](RPC.RPCSPEC09.API.md#address)       |
| `calls`        | [`CALL`](RPC.RPCSPEC09.PAYMASTER_API.md#call)[] |
...
Ƭ **USER_TRANSACTION**: [`USER_DEPLOY_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#user_deploy_transaction) \| [`USER_INVOKE_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#user_invoke_transaction) \| [`USER_DEPLOY_AND_INVOKE_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#user_deploy_and_invoke_transaction)
...
| :------- | :-------------------------------------------------------------------------------- |
| `type`   | `"invoke"`                                                                        |
| `invoke` | [`EXECUTABLE_USER_INVOKE`](RPC.RPCSPEC09.PAYMASTER_API.md#executable_user_invoke) |
...
| :------------- | :----------------------------------------------------------------------------------- |
| `user_address` | [`ADDRESS`](RPC.RPCSPEC09.API.md#address)                                            |
| `typed_data`   | [`OutsideExecutionTypedData`](RPC.RPCSPEC09.WALLET_API.md#outsideexecutiontypeddata) |
...
Ƭ **EXECUTABLE_USER_TRANSACTION**: [`EXECUTABLE_USER_DEPLOY_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#executable_user_deploy_transaction) \| [`EXECUTABLE_USER_INVOKE_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#executable_user_invoke_transaction) \| [`EXECUTABLE_USER_DEPLOY_AND_INVOKE_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#executable_user_deploy_and_invoke_transaction)
...
| :---------- | :---------------------------------- |
| `mode`      | `"default"`                         |
| `gas_token` | [`FELT`](RPC.RPCSPEC09.API.md#felt) |
...
Ƭ **FEE_MODE**: [`SPONSORED_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#sponsored_transaction) \| [`GASLESS_TRANSACTION`](RPC.RPCSPEC09.PAYMASTER_API.md#gasless_transaction)
...
| :------------- | :------------------------------------------------------- |
| `version`      | `"0x1"`                                                  |
| `fee_mode`     | [`FEE_MODE`](RPC.RPCSPEC09.PAYMASTER_API.md#fee_mode)    |
| `time_bounds?` | [`TIME_BOUNDS`](RPC.RPCSPEC09.WALLET_API.md#time_bounds) |
...
Ƭ **EXECUTION_PARAMETERS**: [`EXECUTION_PARAMETERS_V1`](RPC.RPCSPEC09.PAYMASTER_API.md#execution_parameters_v1)
...
| `salt`       | [`FELT`](RPC.RPCSPEC09.API.md#felt)       |
| `calldata`   | [`FELT`](RPC.RPCSPEC09.API.md#felt)[]     |
| `sigdata?`   | [`FELT`](RPC.RPCSPEC09.API.md#felt)[]     |
| `version`    | `1`                                       |
...
| Name            | Type                                          |
| :-------------- | :-------------------------------------------- |
| `token_address` | [`ADDRESS`](RPC.RPCSPEC09.API.md#address)     |
| `decimals`      | `number`                                      |
| `price_in_strk` | [`u256`](RPC.RPCSPEC09.PAYMASTER_API.md#u256) |
...
| Name                             | Type                                |
| :------------------------------- | :---------------------------------- |
| `gas_token_price_in_strk`        | [`FELT`](RPC.RPCSPEC09.API.md#felt) |
| `estimated_fee_in_strk`          | [`FELT`](RPC.RPCSPEC09.API.md#felt) |
| `estimated_fee_in_gas_token`     | [`FELT`](RPC.RPCSPEC09.API.md#felt) |
| `suggested_max_fee_in_strk`      | [`FELT`](RPC.RPCSPEC09.API.md#felt) |
| `suggested_max_fee_in_gas_token` | [`FELT`](RPC.RPCSPEC09.API.md#felt) |
...
| `type`       | `"deploy"`                                                                          |
| `deployment` | [`ACCOUNT_DEPLOYMENT_DATA`](RPC.RPCSPEC09.PAYMASTER_API.md#account_deployment_data) |
| `parameters` | [`EXECUTION_PARAMETERS`](RPC.RPCSPEC09.PAYMASTER_API.md#execution_parameters)       |
| `fee`        | [`FEE_ESTIMATE`](RPC.RPCSPEC09.PAYMASTER_API.md#fee_estimate)                       |
...
Ƭ **BuildTransactionResponse**: [`BuildDeployTransactionResponse`](RPC.RPCSPEC09.PAYMASTER_API.md#builddeploytransactionresponse) \| [`BuildInvokeTransactionResponse`](RPC.RPCSPEC09.PAYMASTER_API.md#buildinvoketransactionresponse) \| [`BuildDeployAndInvokeTransactionResponse`](RPC.RPCSPEC09.PAYMASTER_API.md#builddeployandinvoketransactionresponse)
...
| Name               | Type                                                        |
| :----------------- | :---------------------------------------------------------- |
| `tracking_id`      | [`TRACKING_ID`](RPC.RPCSPEC09.PAYMASTER_API.md#tracking_id) |
...
Ƭ **AccountDeploymentData**: [`ACCOUNT_DEPLOYMENT_DATA`](RPC.RPCSPEC09.PAYMASTER_API.md#account_deployment_data)
