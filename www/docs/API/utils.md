...
Functions to manage strings with 31 characters maximum.

### encodeShortString :

```typescript
encodeShortString(str: string): string
```

Convert an ASCII string to an hexadecimal string.  
Input :

- str: string // 31 characters maxi. Ex : "uri/item23.jpg"

Return :

- string // Hex number 248 bits max
...
return : string : "0x7572692f706963742f7433382e6a7067"

### decodeShortString :

```typescript
decodeShortString(str: string): string
```

Convert a hexadecimal or decimal string to an ASCII string.  
Input :

- str: string // 248 bits max number.  
  Ex : hex : "0x1A4F64EA56"  
  decimal : "236942575435676423"

Return :

- string with 31 characters max
