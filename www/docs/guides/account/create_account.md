...
If you want a specific private key, replace `stark.randomStarkPrivateKey()` with your choice.
...
// Generate public and private key pair.
const privateKeyAX = stark.randomStarkPrivateKey();
...
If you want a specific private key, replace `stark.randomStarkPrivateKey()` with a value of your choice.
...
```typescript
const privateKeyBraavos = stark.randomStarkPrivateKey();
```
...
// Generate public and private key pair.
const AAprivateKey = stark.randomStarkPrivateKey();
