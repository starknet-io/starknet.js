...
import { CallData, Provider, constants, ec, hash, num, stark } from 'starknet';
import {
  CairoVersion,
  Calldata,
...
const BraavosProxyClassHash: num.BigNumberish =
...
export function calculateAddressBraavos(privateKeyBraavos: num.BigNumberish): string {
